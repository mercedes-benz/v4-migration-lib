...
describe('Imports V3 DDO', () => {
  it('Imports 1st DDO', async () => {
    const ddo1 = await getDDO(did1, metadataCacheUri)
    assert(
  ...
  it('Imports 2nd DDO', async () => {
    const ddo2 = await getDDO(did2, metadataCacheUri)
    assert(
  ...
  it('Imports 3rd DDO', async () => {
    const ddo3 = await getDDO(did3, metadataCacheUri)
    assert(
...
describe('Converts V3 DDO to V4 DDO', () => {
  ...
  it('Converts 2nd DDO', async () => {
    const ddo2 = await getAndConvertDDO(
      did2,
      '1234567890',
      nftAddress,
      erc20Address,
  ...
  it('Converts 3rd DDO', async () => {
    const ddo3 = await getAndConvertDDO(
      did3,
      '1234567890',
      nftAddress,
      erc20Address,
