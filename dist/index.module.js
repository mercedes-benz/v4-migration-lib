...
import S from '@oceanprotocol/contracts/artifacts/BFactory.json'
import _ from '@oceanprotocol/contracts/artifacts/FixedRateExchange.json'
...
var it = (function t(e) {
  ...
  function x(t, e) {
    ...
    if (null == e) {
      ...
      if ((h = 'number' == typeof t) && 0 * t == 0) {
        ...
        if (!j.test((d = String(t)))) return n(f, d, h)
    ...
    if ((d = d.slice(u, ++l))) {
      if (
        ((l -= u),
        h && x.DEBUG && l > 15 && (t > 9007199254740991 || t !== W(t)))
      )
        throw Error(H + f.s * t)
  ...
  function E(t, e, i, r) {
    ...
    if (((n = t.c[0]), (a = t.e), null == e))
      (u = J(t.c)),
        (u =
          1 == r || (2 == r && (a <= g || a >= y)) ? tt(u, a) : et(u, a, '0'))
    else if (
      ((s = (t = I(new x(t), e, i)).e),
      (o = (u = J(t.c)).length),
      1 == r || (2 == r && (e <= s || s <= g)))
  ...
  return (
    ...
    (r = (function () {
      ...
      return function (r, n, s, a, o) {
        ...
        if (
          ...
          r = f ? et(u.charAt(1), -w, u.charAt(0)) : u.charAt(0)
        else {
          if (((g.length = h), f))
            for (--s; ++g[--h] > s; )
    ...
    (i = (function () {
      ...
      return function (r, n, s, a, o) {
        ...
        for (
          g = (m = new x(T)).c = [],
            T = s + (h = r.e - n.e) + 1,
            o || ((o = G), (h = V(r.e / 14) - V(n.e / 14)), (T = (T / 14) | 0)),
            l = 0;
          R[l] == (E[l] || 0);
          l++
        );
    ...
    (f.exponentiatedBy = f.pow =
      function (t, e) {
        ...
        if ((t = new x(t)).c && !t.isInteger())
          throw Error($ + 'Exponent not an integer: ' + B(t))
        if (
          (null != e && (e = new x(e)),
          (a = t.e > 14),
          !l.c ||
          ...
          return (
            (h = new x(Math.pow(+B(l), a ? 2 - Q(t) : +B(t)))), e ? h.mod(e) : h
          )
        if (((o = t.s < 0), e)) {
        ...
        for (
          ...
          if (n) {
            if (0 === (n = W(n / 2))) break
            u = n % 2
          } else if ((I((t = t.times(i)), t.e + 1, 1), t.e > 14)) u = Q(t)
          else {
            if (0 == (n = +B(t))) break
            u = n % 2
          }
    ...
    (f.integerValue = function (t) {
      var e = new x(this)
      return null == t ? (t = m) : Y(t, 0, 8), I(e, e.e + 1, t)
    }),
    (f.isEqualTo = f.eq =
      function (t, e) {
        return 0 === X(this, new x(t, e))
      }),
    (f.isFinite = function () {
      return !!this.c
    }),
    (f.isGreaterThan = f.gt =
      function (t, e) {
        return X(this, new x(t, e)) > 0
      }),
    (f.isGreaterThanOrEqualTo = f.gte =
      function (t, e) {
        return 1 === (e = X(this, new x(t, e))) || 0 === e
      }),
    ...
    (f.minus = function (t, e) {
      ...
      if (((u = V(u)), (h = V(h)), (l = l.slice()), (o = u - h))) {
        for (
    ...
    (f.precision = f.sd =
      function (t, e) {
        var i,
          ...
          s = this
        if (null != t && t !== !!t)
          return Y(t, 1, K), null == e ? (e = m) : Y(e, 0, 8), I(new x(s), t, e)
        if (!(i = s.c)) return null
    ...
    (f.toExponential = function (t, e) {
      return null != t && (Y(t, 0, K), t++), E(this, t, e, 1)
    }),
    (f.toFixed = function (t, e) {
      return null != t && (Y(t, 0, K), (t = t + this.e + 1)), E(this, t, e)
    }),
    (f.toFormat = function (t, e, i) {
      ...
      if (null == i)
        ...
        throw Error($ + 'Argument not an object: ' + i)
    ...
    (f.toPrecision = function (t, e) {
      return null != t && Y(t, 1, K), E(this, t, e, 2)
    }),
      ...
      return (
        null === s
          ? n
            ...
            : (e = 'NaN')
          : (null == t
              ? (e = s <= g || s >= y ? tt(J(i.c), s) : et(J(i.c), s, '0'))
              : 10 === t && T
              ? (e = et(J((i = I(new x(i), p + s + 1, m)).c), i.e, '0'))
              : (Y(t, 2, _.length, 'Base'),
                (e = r(et(J(i.c), s, '0'), 10, t, n, !0))),
            n < 0 && i.c[0] && (e = '-' + e)),
        e
      )
    }),
...
async function rt(t, e) {
  const i = new it(await t.eth.getGasPrice())
  return e && e.gasFeeMultiplier
    ? i
        .multipliedBy(e.gasFeeMultiplier)
        .integerValue(it.ROUND_DOWN)
        .toString(10)
    : i.toString(10)
}
function nt(t, e) {
...
class dt extends ut {
  ...
  async list() {
    const t = (await this.web3.eth.getAccounts()).map(
      (t) => new ht(t, this.instanceConfig)
    )
    ...
    return this.fetch(
      ...
      null != e
        ? {
            ...
            body: e,
            headers: i,
            signal: pt(this.requestTimeout)
          }
        : { method: 'POST', signal: pt(this.requestTimeout) }
    )
  }
  get(t) {
    return this.fetch(t, {
...
class gt extends ut {
  ...
  async createSignature(t, e) {
    return await this.ocean.utils.signature.signText(C(e), t.getId())
  }
  ...
  async initialize(t, e, i, r, n) {
    const { did: s, ddo: a } = await at(t, this.ocean)
  ...
  St = function (t) {
    if ('string' == typeof t || 'number' == typeof t) {
      var e = new Mt(1),
        ...
        n = At(i)
      if (
        ('-' === n.substr(0, 1) && ((n = At(n.slice(1))), (e = new Mt(-1, 10))),
        (!(n = '' === n ? '0' : n).match(/^-?[0-9]+$/) &&
          n.match(/^[0-9A-Fa-f]+$/)) ||
          n.match(/^[a-fA-F]+$/) ||
          (!0 === r && n.match(/^[0-9A-Fa-f]+$/)))
      )
        return new Mt(n, 16).mul(e)
      if ((n.match(/^-?[0-9]+$/) || '' === n) && !1 === r)
        return new Mt(n, 10).mul(e)
    } else if (
      'object' == typeof t &&
      t.toString &&
      !t.pop &&
      ...
      return new Mt(t.toString(10), 10)
    throw new Error(
...
var kt = {
    ...
    toWei: function (t, e) {
      ...
      for (; u.length < n; ) u += '0'
      ;(o = new vt(o)), (u = new vt(u))
      var h = o.mul(r).add(u)
      return s && (h = h.mul(Tt)), new vt(h.toString(10), 10)
    }
  },
  It = bt(function (t) {
    !(function (t, e) {
      ...
      ;(n.isBN = function (t) {
        ...
        (n.prototype._parseBase = function (t, e, i) {
          ...
          if (0 !== a) {
            var d = 1
            for (u = h(t, l, t.length, e), l = 0; l < a; l++) d *= e
            this.imuln(d),
              this.words[0] + u < 67108864
                ? (this.words[0] += u)
                : this._iaddn(u)
      ...
      ;(n.prototype.toString = function (t, e) {
        ...
        if (t === (0 | t) && t >= 2 && t <= 36) {
          ...
          for (p.negative = 0; !p.isZero(); ) {
            var m = p.modn(c).toString(t)
            r = (p = p.idivn(c)).isZero() ? m + r : l[h - m.length] + m + r
          }
          for (this.isZero() && (r = '0' + r); r.length % e != 0; ) r = '0' + r
          return 0 !== this.negative && (r = '-' + r), r
        }
      ...
      ;(n.prototype.toString = function (t, e) {
        ...
        if (t === (0 | t) && t >= 2 && t <= 36) {
          ...
          for (d.negative = 0; !d.isZero(); ) {
            var m = d.modrn(l).toString(t)
            r = (d = d.idivn(l)).isZero() ? m + r : f[h - m.length] + m + r
          }
          for (this.isZero() && (r = '0' + r); r.length % e != 0; ) r = '0' + r
          return 0 !== this.negative && (r = '-' + r), r
        }
  ...
  Lt = bt(function (t, e) {
    Object.defineProperty(e, '__esModule', { value: !0 }),
      (e.KECCAK256_RLP =
        ...
        e.MAX_UINT64 =
          void 0),
      (e.MAX_UINT64 = new Nt.BN('ffffffffffffffff', 16)),
      (e.MAX_INTEGER = new Nt.BN(
        'ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff',
        16
      )),
      (e.TWO_POW256 = new Nt.BN(
  ...
  Dt = 'function' == typeof __webpack_require__ ? __non_webpack_require__ : wt,
  Ft = (process.config && process.config.variables) || {},
  Ut = !!process.env.PREBUILDS_ONLY,
  qt = process.versions.modules,
  jt =
  ...
  $t =
    ...
    ((function (t) {
      ...
      ? 'musl'
      : 'glibc'),
  Ht = process.env.ARM_VERSION || ('arm64' === zt ? '8' : Ft.arm_version) || '',
  Gt = (process.versions.uv || '').split('.')[0],
  Zt = Kt
function Kt(t) {
  return Dt(Kt.path(t))
}
...
;(Kt.path = function (t) {
  t = c.resolve(t || '.')
  try {
    var e = Dt(c.join(t, 'package.json')).name.toUpperCase().replace(/-/g, '_')
    process.env[e + '_PREBUILD'] && (t = process.env[e + '_PREBUILD'])
  } catch (t) {}
  if (!Ut) {
    var i = Jt(c.join(t, 'build/Release'), Xt)
    if (i) return i
    var r = Jt(c.join(t, 'build/Debug'), Xt)
    if (r) return r
  }
  var n = o(t)
  if (n) return n
  ...
  function o(t) {
    var e = Vt(c.join(t, 'prebuilds')).map(Yt).filter(Qt(Wt, zt)).sort(te)[0]
    if (e) {
      var i = c.join(t, 'prebuilds', e.name),
        r = Vt(i).map(ee).filter(ie(jt, qt)).sort(re(jt))[0]
  ...
  (Kt.matchTuple = Qt),
  (Kt.compareTuples = te)
const ne = 'Impossible case. Please create issue.',
  se = 'The tweak was out of range or the resulted private key is invalid',
  ae = 'Public Key could not be parsed',
  oe = 'Signature could not be parsed'
function ue(t, e) {
  if (!t) throw new Error(e)
}
function he(t, e, i) {
  if (
    (ue(e instanceof Uint8Array, `Expected ${t} to be an Uint8Array`),
    void 0 !== i)
  )
    if (Array.isArray(i)) {
      ...
      ue(i.includes(e.length), r)
    } else
      ue(e.length === i, `Expected ${t} to be an Uint8Array with length ${i}`)
}
function le(t) {
  ue('Boolean' === fe(t), 'Expected compressed to be a Boolean')
}
function de(t = (t) => new Uint8Array(t), e) {
  return 'function' == typeof t && (t = t(e)), he('output', t, e), t
}
function fe(t) {
...
var ce = (t) => ({
    ...
    privateKeyVerify: (e) => (
      he('private key', e, 32), 0 === t.privateKeyVerify(e)
    ),
    privateKeyNegate(e) {
      switch ((he('private key', e, 32), t.privateKeyNegate(e))) {
        case 0:
          return e
        case 1:
          throw new Error(ne)
    ...
    publicKeyVerify: (e) => (
      he('public key', e, [33, 65]), 0 === t.publicKeyVerify(e)
    ),
    ...
    publicKeyCombine(e, i = !0, r) {
      ue(Array.isArray(e), 'Expected public keys to be an Array'),
        ue(
          e.length > 0,
          'Expected public keys array will have more than zero items'
        )
      for (const t of e) he('public key', t, [33, 65])
      switch ((le(i), (r = de(r, i ? 33 : 65)), t.publicKeyCombine(r, e))) {
        case 0:
          return r
        case 1:
          throw new Error(ae)
    ...
    signatureNormalize(e) {
      switch ((he('signature', e, 64), t.signatureNormalize(e))) {
        case 0:
          return e
        case 1:
          throw new Error(oe)
    ...
    signatureExport(e, i) {
      he('signature', e, 64)
      const r = { output: (i = de(i, 72)), outputlen: 72 }
    ...
    signatureImport(e, i) {
      switch ((he('signature', e), (i = de(i, 64)), t.signatureImport(i, e))) {
        case 0:
          return i
        case 1:
          throw new Error(oe)
    ...
    ecdsaSign(e, i, r = {}, n) {
      he('message', e, 32),
        he('private key', i, 32),
        ue('Object' === fe(r), 'Expected options to be an Object'),
        void 0 !== r.data && he('options.data', r.data),
        void 0 !== r.noncefn &&
          ue(
            'Function' === fe(r.noncefn),
            'Expected options.noncefn to be a Function'
          )
      const s = { signature: (n = de(n, 64)), recid: null }
    ...
    ecdh(e, i, r = {}, n) {
      switch (
        ...
        void 0 !== r.hashfn
          ? (ue(
              'Function' === fe(r.hashfn),
              'Expected options.hashfn to be a Function'
            ),
            void 0 !== r.xbuf && he('options.xbuf', r.xbuf, 32),
            void 0 !== r.ybuf && he('options.ybuf', r.ybuf, 32),
            he('output', n))
          : (n = de(n, 32)),
  ...
  pe = ce(new (Zt(__dirname).Secp256k1)()),
  me = ge
function ge(t, e) {
  if (!t) throw new Error(e || 'Assertion failed')
}
ge.equal = function (t, e, i) {
  ...
  we = bt(function (t, e) {
    ...
    ;(i.assert = me),
      ...
      (i.intFromLE = function (t) {
        return new It(t, 'hex', 'le')
      })
  }),
  ve = function (t) {
    return ye || (ye = new Me(null)), ye.generate(t)
  }
function Me(t) {
  this.rand = t
}
...
function Ee(t, e) {
  ;(this.type = t),
    (this.p = new It(e.p, 16)),
    (this.red = e.prime ? It.red(e.prime) : It.mont(this.p)),
    (this.zero = new It(0).toRed(this.red)),
    (this.one = new It(1).toRed(this.red)),
    (this.two = new It(2).toRed(this.red)),
    (this.n = e.n && new It(e.n, 16)),
...
;(Ee.prototype.point = function () {
  throw new Error('Not implemented')
}),
  (Ee.prototype.validate = function () {
    throw new Error('Not implemented')
  }),
  (Ee.prototype._fixedNafMul = function (t, e) {
    xe(t.precomputed)
    var i = t._getDoubles(),
      r = _e(e, 1, this._bitLength),
  ...
  (Ee.prototype._wnafMul = function (t, e) {
    for (
      var i = 4,
        r = t._getNAFPoints(i),
        n = r.points,
        s = _e(e, (i = r.wnd), this._bitLength),
  ...
  (Ee.prototype._wnafMulAdd = function (t, e, i, r, n) {
    var s,
      a,
      o,
      u = this._wnafT1,
    ...
    for (s = r - 1; s >= 1; s -= 2) {
      ...
      if (1 === u[c] && 1 === u[p]) {
        ...
        (l[c] = _e(i[c], u[c], this._bitLength)),
          (l[p] = _e(i[p], u[p], this._bitLength)),
  ...
  (Ee.BasePoint = ke),
  (ke.prototype.eq = function () {
    throw new Error('Not implemented')
  }),
  (ke.prototype.validate = function () {
    return this.curve.validate(this)
  }),
  (Ee.prototype.decodePoint = function (t, e) {
    t = we.toArray(t, e)
  ...
  (ke.prototype.encodeCompressed = function (t) {
    return this.encode(t, !0)
  }),
  (ke.prototype._encode = function (t) {
  ...
  (ke.prototype.encode = function (t, e) {
    return we.encode(this._encode(e), t)
  }),
  (ke.prototype.precompute = function (t) {
  ...
  (ke.prototype._hasDoubles = function (t) {
    if (!this.precomputed) return !1
    var e = this.precomputed.doubles
    return !!e && e.points.length >= Math.ceil((t.bitLength() + 1) / e.step)
  }),
  (ke.prototype._getDoubles = function (t, e) {
  ...
  (ke.prototype._getNAFPoints = function (t) {
...
function Pe(t) {
  Re.call(this, 'short', t),
    (this.a = new It(t.a, 16).toRed(this.red)),
    (this.b = new It(t.b, 16).toRed(this.red)),
...
function De(t) {
  Re.call(this, 'mont', t),
    (this.a = new It(t.a, 16).toRed(this.red)),
    (this.b = new It(t.b, 16).toRed(this.red)),
    (this.i4 = new It(4).toRed(this.red).redInvm()),
    (this.two = new It(2).toRed(this.red)),
    (this.a24 = this.i4.redMul(this.a.redAdd(this.two)))
}
;(Pe.prototype._getEndomorphism = function (t) {
  if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) {
    var e, i
    if (t.beta) e = new It(t.beta, 16).toRed(this.red)
    else {
      var r = this._getEndoRoots(this.p)
      e = (e = r[0].cmp(r[1]) < 0 ? r[0] : r[1]).toRed(this.red)
    }
    if (t.lambda) i = new It(t.lambda, 16)
    else {
      var n = this._getEndoRoots(this.n)
      0 === this.g.mul(n[0]).x.cmp(this.g.x.redMul(e))
        ? (i = n[0])
        : Oe(0 === this.g.mul((i = n[1])).x.cmp(this.g.x.redMul(e)))
    }
    return {
      beta: e,
      lambda: i,
      basis: t.basis
        ? t.basis.map(function (t) {
            return { a: new It(t.a, 16), b: new It(t.b, 16) }
          })
        : this._getEndoBasis(i)
    }
  }
}),
  (Pe.prototype._getEndoRoots = function (t) {
    var e = t === this.p ? this.red : It.mont(t),
      i = new It(2).toRed(e).redInvm(),
      r = i.redNeg(),
      n = new It(3).toRed(e).redNeg().redSqrt().redMul(i)
    return [r.redAdd(n).fromRed(), r.redSub(n).fromRed()]
  }),
  (Pe.prototype._getEndoBasis = function (t) {
    for (
      var e,
        i,
        r,
  ...
  (Pe.prototype._endoSplit = function (t) {
  ...
  (Pe.prototype.pointFromX = function (t, e) {
    ;(t = new It(t, 16)).red || (t = t.toRed(this.red))
  ...
  (Pe.prototype.validate = function (t) {
    if (t.inf) return !0
    var e = t.x,
      i = t.y,
      r = this.a.redMul(e),
  ...
  (Pe.prototype._endoWnafMulAdd = function (t, e, i) {
    for (
  ...
  Be(Ne, Re.BasePoint),
  (Pe.prototype.point = function (t, e, i) {
    return new Ne(this, t, e, i)
  }),
  (Pe.prototype.pointFromJSON = function (t, e) {
    return Ne.fromJSON(this, t, e)
  }),
  ...
  (Ne.prototype.getY = function () {
    return this.y.fromRed()
  }),
  (Ne.prototype.mul = function (t) {
    return (
      (t = new It(t, 16)),
      this.isInfinity()
        ? this
  ...
  (Ne.prototype.mulAdd = function (t, e, i) {
    var r = [this, e],
      n = [t, i]
  ...
  (Ne.prototype.jmulAdd = function (t, e, i) {
    var r = [this, e],
      n = [t, i]
    return this.curve.endo
  ...
  (Ne.prototype.toJ = function () {
    return this.inf
      ? this.curve.jpoint(null, null, null)
      : this.curve.jpoint(this.x, this.y, this.curve.one)
  }),
  Be(Le, Re.BasePoint),
  (Pe.prototype.jpoint = function (t, e, i) {
  ...
  (Le.prototype.mixedAdd = function (t) {
  ...
  (Le.prototype.mul = function (t, e) {
    return (t = new It(t, e)), this.curve._wnafMul(this, t)
  }),
...
var Fe = De
function Ue(t, e, i) {
  Re.BasePoint.call(this, t, 'projective'),
    null === e && null === i
...
;(De.prototype.validate = function (t) {
  var e = t.normalize().x,
    i = e.redSqr(),
  ...
  Be(Ue, Re.BasePoint),
  (De.prototype.decodePoint = function (t, e) {
    return this.point(we.toArray(t, e), 1)
  }),
  (De.prototype.point = function (t, e) {
    return new Ue(this, t, e)
  }),
  (De.prototype.pointFromJSON = function (t) {
    return Ue.fromJSON(this, t)
  }),
  (Ue.prototype.precompute = function () {}),
  (Ue.prototype._encode = function () {
    return this.getX().toArray('be', this.curve.p.byteLength())
  }),
  (Ue.fromJSON = function (t, e) {
    return new Ue(t, e[0], e[1] || t.one)
  }),
  ...
  (Ue.prototype.diffAdd = function (t, e) {
  ...
  (Ue.prototype.mulAdd = function () {
    throw new Error('Not supported on Montgomery curve')
  }),
  (Ue.prototype.jumlAdd = function () {
    throw new Error('Not supported on Montgomery curve')
  }),
...
function je(t) {
  ;(this.twisted = 1 != (0 | t.a)),
    ...
    Re.call(this, 'edwards', t),
    (this.a = new It(t.a, 16).umod(this.red.m)),
    (this.a = this.a.toRed(this.red)),
    (this.c = new It(t.c, 16).toRed(this.red)),
    (this.c2 = this.c.redSqr()),
    (this.d = new It(t.d, 16).toRed(this.red)),
    (this.dd = this.d.redAdd(this.d)),
    qe(!this.twisted || 0 === this.c.fromRed().cmpn(1)),
    (this.oneC = 1 == (0 | t.c))
}
Be(je, Re)
var ze = je
function We(t, e, i, r, n) {
  Re.BasePoint.call(this, t, 'projective'),
    null === e && null === i && null === r
      ...
      : ((this.x = new It(e, 16)),
        (this.y = new It(i, 16)),
        (this.z = r ? new It(r, 16) : this.curve.one),
        (this.t = n && new It(n, 16)),
        this.x.red || (this.x = this.x.toRed(this.curve.red)),
        this.y.red || (this.y = this.y.toRed(this.curve.red)),
        this.z.red || (this.z = this.z.toRed(this.curve.red)),
...
;(je.prototype._mulA = function (t) {
  return this.mOneA ? t.redNeg() : this.a.redMul(t)
}),
  (je.prototype._mulC = function (t) {
    return this.oneC ? t : this.c.redMul(t)
  }),
  (je.prototype.jpoint = function (t, e, i, r) {
  ...
  (je.prototype.pointFromY = function (t, e) {
    ;(t = new It(t, 16)).red || (t = t.toRed(this.red))
    var i = t.redSqr(),
      r = i.redSub(this.c2),
  ...
  Be(We, Re.BasePoint),
  (je.prototype.pointFromJSON = function (t) {
    return We.fromJSON(this, t)
  }),
  (je.prototype.point = function (t, e, i, r) {
    return new We(this, t, e, i, r)
  }),
  (We.fromJSON = function (t, e) {
    return new We(t, e[0], e[1], e[2])
  }),
  ...
  (We.prototype._extAdd = function (t) {
  ...
  (We.prototype._projAdd = function (t) {
    var e,
      i,
      r = this.z.redMul(t.z),
      n = r.redSqr(),
  ...
  (We.prototype.mulAdd = function (t, e, i) {
    return this.curve._wnafMulAdd(1, [this, e], [t, i], 2, !1)
  }),
  (We.prototype.jmulAdd = function (t, e, i) {
  ...
  (We.prototype.eqXToP = function (t) {
...
var $e = bt(function (t, e) {
  var i = e
  ;(i.base = Re), (i.short = Ce), (i.mont = Fe), (i.edwards = ze)
})
function He(t, e) {
  return (
...
var Ve = {
  ...
  toHex: function (t) {
    for (var e = '', i = 0; i < t.length; i++) e += Ze(t[i].toString(16))
    return e
  },
  htonl: Ge,
  toHex32: function (t, e) {
    for (var i = '', r = 0; r < t.length; r++) {
      var n = t[r]
      'little' === e && (n = Ge(n)), (i += Ke(n.toString(16)))
    }
    return i
  },
  zero2: Ze,
...
;(Je.prototype.update = function (t, e) {
  if (
    ...
    ;(this.pending = t.slice(t.length - i, t.length)),
      ...
      (t = Ve.join32(t, 0, t.length - i, this.endian))
  ...
  (Je.prototype.digest = function (t) {
    return this.update(this._pad()), me(null === this.pending), this._digest(t)
  }),
...
;(li.blockSize = 512),
  ...
  (li.prototype._update = function (t, e) {
    ...
    for (; r < i.length; r++)
      i[r] = ni(i[r - 3] ^ i[r - 8] ^ i[r - 14] ^ i[r - 16], 1)
    var n = this.h[0],
      s = this.h[1],
      a = this.h[2],
      o = this.h[3],
    ...
    for (r = 0; r < i.length; r++) {
      var h = ~~(r / 20),
        l = ai(ni(n, 5), oi(h, s, a, o), u, i[r], hi[h])
      ;(u = o), (o = a), (a = ni(s, 30)), (s = n), (n = l)
    }
    ;(this.h[0] = si(this.h[0], n)),
      (this.h[1] = si(this.h[1], s)),
      (this.h[2] = si(this.h[2], a)),
      (this.h[3] = si(this.h[3], o)),
      (this.h[4] = si(this.h[4], u))
  }),
  (li.prototype._digest = function (t) {
    return 'hex' === t ? Ve.toHex32(this.h, 'big') : Ve.split32(this.h, 'big')
  })
var fi = Ve.sum32,
  ci = Ve.sum32_4,
  pi = Ve.sum32_5,
  ...
  gi = ri,
  yi = function (t) {
    return Qe(t, 2) ^ Qe(t, 13) ^ Qe(t, 22)
  },
  bi = function (t) {
    return Qe(t, 6) ^ Qe(t, 11) ^ Qe(t, 25)
  },
  wi = function (t) {
    return Qe(t, 7) ^ Qe(t, 18) ^ (t >>> 3)
  },
  vi = Ye.BlockHash,
  Mi = [
...
;(Ai.blockSize = 512),
  ...
  (Ai.hmacStrength = 192),
  (Ai.padLength = 64),
  (Ai.prototype._update = function (t, e) {
    for (var i = this.W, r = 0; r < 16; r++) i[r] = t[e + r]
    for (; r < i.length; r++)
      i[r] = ci(
        Qe((n = i[r - 2]), 17) ^ Qe(n, 19) ^ (n >>> 10),
        i[r - 7],
        wi(i[r - 15]),
        i[r - 16]
      )
    var n,
      ...
      d = this.h[6],
      f = this.h[7]
    for (me(this.k.length === i.length), r = 0; r < i.length; r++) {
      var c = pi(f, bi(h), mi(h, l, d), this.k[r], i[r]),
        p = fi(yi(s), gi(s, a, o))
      ;(f = d),
        (d = l),
        (l = h),
    ...
    ;(this.h[0] = fi(this.h[0], s)),
      (this.h[1] = fi(this.h[1], a)),
      (this.h[2] = fi(this.h[2], o)),
      (this.h[3] = fi(this.h[3], u)),
      (this.h[4] = fi(this.h[4], h)),
      (this.h[5] = fi(this.h[5], l)),
      (this.h[6] = fi(this.h[6], d)),
      (this.h[7] = fi(this.h[7], f))
  }),
...
;(_i.blockSize = 512),
  ...
  (_i.prototype._digest = function (t) {
    return 'hex' === t
      ? Ve.toHex32(this.h.slice(0, 7), 'big')
      : Ve.split32(this.h.slice(0, 7), 'big')
  })
var xi = Ve.rotr64_hi,
  Ei = Ve.rotr64_lo,
  Ri = Ve.shr64_hi,
...
function Vi(t, e) {
  var i = xi(t, e, 1) ^ xi(t, e, 8) ^ Ri(t, e, 7)
  return i < 0 && (i += 4294967296), i
}
function Ji(t, e) {
...
function Xi(t, e) {
  var i = xi(t, e, 19) ^ xi(e, t, 29) ^ Ri(t, e, 6)
  return i < 0 && (i += 4294967296), i
}
function Yi(t, e) {
...
;(Ui.blockSize = 1024),
  ...
  (Ui.hmacStrength = 192),
  (Ui.padLength = 128),
  (Ui.prototype._prepareBlock = function (t, e) {
    for (var i = this.W, r = 0; r < 32; r++) i[r] = t[e + r]
    for (; r < i.length; r += 2) {
      var n = Xi(i[r - 4], i[r - 3]),
        s = Yi(i[r - 4], i[r - 3]),
        a = i[r - 14],
        o = i[r - 13],
        u = Vi(i[r - 30], i[r - 29]),
        ...
        l = i[r - 32],
        d = i[r - 31]
      ;(i[r] = Pi(n, s, a, o, u, h, l, d)),
        (i[r + 1] = Ci(n, s, a, o, u, h, l, d))
    }
  }),
  (Ui.prototype._update = function (t, e) {
    ...
    for (var w = 0; w < i.length; w += 2) {
      var v = y,
        ...
        R = i[w],
        k = i[w + 1],
        I = Ni(v, M, A, S, _, T, x, E, R, k),
        B = Li(v, M, A, S, _, T, x, E, R, k)
      ;(v = Hi(r, n)),
        (M = Gi(r, n)),
        (A = Wi(r, 0, s, 0, o)),
        (S = $i(0, n, 0, a, 0, u))
...
;(Qi.blockSize = 1024),
  ...
  (Qi.prototype._digest = function (t) {
    return 'hex' === t
      ? Ve.toHex32(this.h.slice(0, 12), 'big')
      : Ve.split32(this.h.slice(0, 12), 'big')
  })
var er = { sha1: di, sha224: Ti, sha256: Si, sha384: tr, sha512: qi },
  ir = Ve.rotl32,
  rr = Ve.sum32,
  nr = Ve.sum32_3,
  sr = Ve.sum32_4,
...
;(or.blockSize = 512),
  ...
  (or.prototype._update = function (t, e) {
    for (
      ...
      var c = rr(ir(sr(i, hr(f, r, n, s), t[fr[f] + e], lr(f)), pr[f]), a)
      ;(i = a),
        (a = s),
        (s = ir(n, 10)),
        (n = r),
        (r = c),
        (c = rr(ir(sr(o, hr(79 - f, u, h, l), t[cr[f] + e], dr(f)), mr[f]), d)),
        (o = d),
        (d = l),
        (l = ir(h, 10)),
        (h = u),
    ...
    ;(c = nr(this.h[1], n, l)),
      (this.h[1] = nr(this.h[2], s, d)),
      (this.h[2] = nr(this.h[3], a, o)),
      (this.h[3] = nr(this.h[4], i, u)),
      (this.h[4] = nr(this.h[0], r, h)),
      (this.h[0] = c)
  }),
...
var fr = [
  ...
  gr = { ripemd160: ur }
function yr(t, e, i) {
  if (!(this instanceof yr)) return new yr(t, e, i)
  ;(this.Hash = t),
    (this.blockSize = t.blockSize / 8),
    (this.outSize = t.outSize / 8),
    (this.inner = null),
    (this.outer = null),
    this._init(Ve.toArray(e, i))
}
var br = yr
;(yr.prototype._init = function (t) {
  t.length > this.blockSize && (t = new this.Hash().update(t).digest()),
    me(t.length <= this.blockSize)
  ...
  (yr.prototype.update = function (t, e) {
    return this.inner.update(t, e), this
  }),
  (yr.prototype.digest = function (t) {
    return this.outer.update(this.inner.digest()), this.outer.digest(t)
  })
var wr = bt(function (t, e) {
    var i = e
    ;(i.utils = Ve),
      (i.common = Ye),
      (i.sha = er),
...
function Ar(t) {
  ...
  ;(this.hash = t.hash),
    ...
    (this.K = null),
    (this.V = null)
  var e = be.toArray(t.entropy, t.entropyEnc || 'hex'),
    i = be.toArray(t.nonce, t.nonceEnc || 'hex'),
    r = be.toArray(t.pers, t.persEnc || 'hex')
  me(
...
;(Ar.prototype._init = function (t, e, i) {
  ...
  (Ar.prototype.reseed = function (t, e, i, r) {
  ...
  (Ar.prototype.generate = function (t, e, i, r) {
    if (this._reseed > this.reseedInterval)
      throw new Error('Reseed is required')
    'string' != typeof e && ((r = i), (i = e), (e = null)),
      i && ((i = be.toArray(i, r || 'hex')), this._update(i))
    for (var n = []; n.length < t; )
      (this.V = this._hmac().update(this.V).digest()), (n = n.concat(this.V))
    var s = n.slice(0, t)
    return this._update(i), this._reseed++, be.encode(s, e)
  })
var _r = we.assert
function Tr(t, e) {
  ;(this.ec = t),
...
var xr = Tr
;(Tr.fromPublic = function (t, e, i) {
  return e instanceof Tr ? e : new Tr(t, { pub: e, pubEnc: i })
}),
  (Tr.fromPrivate = function (t, e, i) {
    return e instanceof Tr ? e : new Tr(t, { priv: e, privEnc: i })
  }),
  ...
  (Tr.prototype.getPublic = function (t, e) {
    return (
  ...
  (Tr.prototype._importPrivate = function (t, e) {
    ;(this.priv = new It(t, e || 16)),
      (this.priv = this.priv.umod(this.ec.curve.n))
  }),
  (Tr.prototype._importPublic = function (t, e) {
    if (t.x || t.y)
      return (
        'mont' === this.ec.curve.type
          ? _r(t.x, 'Need x coordinate')
          : ('short' !== this.ec.curve.type &&
              'edwards' !== this.ec.curve.type) ||
            _r(t.x && t.y, 'Need both x and y coordinate'),
  ...
  (Tr.prototype.derive = function (t) {
    return (
      t.validate() || _r(t.validate(), 'public point not validated'),
      t.mul(this.priv).getX()
    )
  }),
  (Tr.prototype.sign = function (t, e, i) {
    return this.ec.sign(t, this, e, i)
  }),
  (Tr.prototype.verify = function (t, e) {
...
function Rr(t, e) {
  ...
  this._importDER(t, e) ||
    (Er(t.r && t.s, 'Signature without r or s'),
    (this.r = new It(t.r, 16)),
    (this.s = new It(t.s, 16)),
...
;(Rr.prototype._importDER = function (t, e) {
  ...
  return (
    (this.r = new It(s)), (this.s = new It(o)), (this.recoveryParam = null), !0
  )
}),
  (Rr.prototype.toDER = function (t) {
    ...
    for (
      ...
      i = i.slice(1)
    var r = [2]
    Pr(r, e.length), (r = r.concat(e)).push(2), Pr(r, i.length)
    var n = r.concat(i),
      s = [48]
    return Pr(s, n.length), (s = s.concat(n)), we.encode(s, t)
  })
var Cr = we.assert
function Nr(t) {
  if (!(this instanceof Nr)) return new Nr(t)
  'string' == typeof t &&
    (Cr(Object.prototype.hasOwnProperty.call(Mr, t), 'Unknown curve ' + t),
    (t = Mr[t])),
    t instanceof Mr.PresetCurve && (t = { curve: t }),
...
var Lr = Nr
;(Nr.prototype.keyPair = function (t) {
  return new xr(this, t)
}),
  (Nr.prototype.keyFromPrivate = function (t, e) {
    return xr.fromPrivate(this, t, e)
  }),
  (Nr.prototype.keyFromPublic = function (t, e) {
    return xr.fromPublic(this, t, e)
  }),
  (Nr.prototype.genKeyPair = function (t) {
    t || (t = {})
    for (
      var e = new Sr({
          hash: this.hash,
  ...
  (Nr.prototype.sign = function (t, e, i, r) {
    ...
    for (
      var n = this.n.byteLength(),
        ...
        u = this.n.sub(new It(1)),
        h = 0;
      ;
      h++
    ) {
      var l = r.k ? r.k(h) : new It(o.generate(this.n.byteLength()))
            ...
            if (0 !== (p = p.umod(this.n)).cmpn(0)) {
              ...
              return (
                r.canonical &&
                  p.cmp(this.nh) > 0 &&
                  ((p = this.n.sub(p)), (m ^= 1)),
                new kr({ r: c, s: p, recoveryParam: m })
              )
            }
          }
        }
  ...
  (Nr.prototype.verify = function (t, e, i, r) {
    ;(t = this._truncateToN(new It(t, 16))), (i = this.keyFromPublic(i, r))
    var n = (e = new kr(e, 'hex')).r,
      s = e.s
  ...
  (Nr.prototype.recoverPubKey = function (t, e, i, r) {
    Cr((3 & i) === i, 'The recovery param is more than two bits'),
      (e = new kr(e, r))
    var n = this.n,
      s = new It(t),
      a = e.r,
  ...
  (Nr.prototype.getKeyRecoveryParam = function (t, e, i, r) {
    if (null !== (e = new kr(e, r)).recoveryParam) return e.recoveryParam
    for (var n = 0; n < 4; n++) {
      var s
      try {
...
var Dr = we.assert,
  Fr = we.parseBytes,
  Ur = we.cachedProperty
function qr(t, e) {
  ;(this.eddsa = t),
    (this._secret = Fr(e.secret)),
    t.isPoint(e.pub) ? (this._pub = e.pub) : (this._pubBytes = Fr(e.pub))
}
;(qr.fromPublic = function (t, e) {
  return e instanceof qr ? e : new qr(t, { pub: e })
}),
  (qr.fromSecret = function (t, e) {
    return e instanceof qr ? e : new qr(t, { secret: e })
  }),
  (qr.prototype.secret = function () {
    return this._secret
  }),
  Ur(qr, 'pubBytes', function () {
  ...
  Ur(qr, 'messagePrefix', function () {
    return this.hash().slice(this.eddsa.encodingLength)
  }),
  (qr.prototype.sign = function (t) {
    return Dr(this._secret, 'KeyPair can only verify'), this.eddsa.sign(t, this)
  }),
  ...
  (qr.prototype.getSecret = function (t) {
    return (
      Dr(this._secret, 'KeyPair is public only'), we.encode(this.secret(), t)
    )
  }),
...
function Hr(t, e) {
  ;(this.eddsa = t),
    ...
    zr(e.R && e.S, 'Signature without R or S'),
    t.isPoint(e.R) && (this._R = e.R),
    e.S instanceof It && (this._S = e.S),
...
Wr(Hr, 'S', function () {
  ...
  Wr(Hr, 'Rencoded', function () {
    return this.eddsa.encodePoint(this.R())
  }),
  Wr(Hr, 'Sencoded', function () {
    return this.eddsa.encodeInt(this.S())
  }),
  (Hr.prototype.toBytes = function () {
    return this.Rencoded().concat(this.Sencoded())
  }),
  (Hr.prototype.toHex = function () {
...
function Vr(t) {
  if (
    (Zr('ed25519' === t, 'only tested with ed25519 so far'),
    !(this instanceof Vr))
  )
    return new Vr(t)
  ;(this.curve = t = Mr[t].curve),
    (this.g = t.g),
...
var Jr = Vr
;(Vr.prototype.sign = function (t, e) {
  t = Kr(t)
  ...
  (Vr.prototype.verify = function (t, e, i) {
    ;(t = Kr(t)), (e = this.makeSignature(e))
    var r = this.keyFromPublic(i),
      n = this.hashInt(e.Rencoded(), r.pubBytes(), t),
      s = this.g.mul(e.S())
    return e.R().add(r.pub().mul(n)).eq(s)
  }),
  (Vr.prototype.hashInt = function () {
    for (var t = this.hash(), e = 0; e < arguments.length; e++)
      t.update(arguments[e])
    return we.intFromLE(t.digest()).umod(this.curve.n)
  }),
  (Vr.prototype.keyFromPublic = function (t) {
    return jr.fromPublic(this, t)
  }),
  (Vr.prototype.keyFromSecret = function (t) {
    return jr.fromSecret(this, t)
  }),
  (Vr.prototype.makeSignature = function (t) {
    return t instanceof Gr ? t : new Gr(this, t)
  }),
  (Vr.prototype.encodePoint = function (t) {
    var e = t.getY().toArray('le', this.encodingLength)
    return (e[this.encodingLength - 1] |= t.getX().isOdd() ? 128 : 0), e
  }),
  (Vr.prototype.decodePoint = function (t) {
  ...
  (Vr.prototype.encodeInt = function (t) {
    return t.toArray('le', this.encodingLength)
  }),
  (Vr.prototype.decodeInt = function (t) {
    return we.intFromLE(t)
  }),
  (Vr.prototype.isPoint = function (t) {
    return t instanceof this.pointClass
  })
var Xr = bt(function (t, e) {
  var i = e
  ;(i.version = '6.5.4'),
    (i.utils = we),
    (i.rand = ve),
...
const Yr = new (0, Xr.ec)('secp256k1'),
  Qr = Yr.curve,
  tn = Qr.n.constructor
function en(t) {
  const e = t[0]
  switch (e) {
    ...
    case 3:
      return 33 !== t.length
        ...
        : (function (t, e) {
            let i = new tn(e)
            if (i.cmp(Qr.p) >= 0) return null
            i = i.toRed(Qr.red)
            let r = i.redSqr().redIMul(i).redIAdd(Qr.b).redSqrt()
            return (
              (3 === t) !== r.isOdd() && (r = r.redNeg()),
              Yr.keyPair({ pub: { x: i, y: r } })
            )
          })(e, t.subarray(1, 33))
    case 4:
    case 6:
    case 7:
      return 65 !== t.length
        ...
        : (function (t, e, i) {
            let r = new tn(e),
              n = new tn(i)
            if (r.cmp(Qr.p) >= 0 || n.cmp(Qr.p) >= 0) return null
            if (
              ((r = r.toRed(Qr.red)),
              (n = n.toRed(Qr.red)),
              (6 === t || 7 === t) && n.isOdd() !== (7 === t))
            ...
            return n.redSqr().redISub(s.redIAdd(Qr.b)).isZero()
              ? Yr.keyPair({ pub: { x: r, y: n } })
              : null
...
var nn = {
    ...
    privateKeyVerify(t) {
      const e = new tn(t)
      return e.cmp(Qr.n) < 0 && !e.isZero() ? 0 : 1
    },
    privateKeyNegate(t) {
      const e = new tn(t),
        i = Qr.n.sub(e).umod(Qr.n).toArrayLike(Uint8Array, 'be', 32)
      return t.set(i), 0
    },
    privateKeyTweakAdd(t, e) {
      const i = new tn(e)
      if (i.cmp(Qr.n) >= 0) return 1
      if ((i.iadd(new tn(t)), i.cmp(Qr.n) >= 0 && i.isub(Qr.n), i.isZero()))
        return 1
    ...
    privateKeyTweakMul(t, e) {
      let i = new tn(e)
      if (i.cmp(Qr.n) >= 0 || i.isZero()) return 1
      i.imul(new tn(t)), i.cmp(Qr.n) >= 0 && (i = i.umod(Qr.n))
      const r = i.toArrayLike(Uint8Array, 'be', 32)
      return t.set(r), 0
    },
    publicKeyVerify: (t) => (null === en(t) ? 1 : 0),
    publicKeyCreate(t, e) {
      const i = new tn(e)
      return i.cmp(Qr.n) >= 0 || i.isZero()
        ? 1
        : (rn(t, Yr.keyFromPrivate(e).getPublic()), 0)
    },
    publicKeyConvert(t, e) {
      const i = en(e)
      return null === i ? 1 : (rn(t, i.getPublic()), 0)
    },
    publicKeyNegate(t, e) {
      const i = en(e)
      if (null === i) return 1
      const r = i.getPublic()
      return (r.y = r.y.redNeg()), rn(t, r), 0
    },
    publicKeyCombine(t, e) {
      const i = new Array(e.length)
      for (let t = 0; t < e.length; ++t)
        if (((i[t] = en(e[t])), null === i[t])) return 1
      let r = i[0].getPublic()
      for (let t = 1; t < i.length; ++t) r = r.add(i[t].pub)
      return r.isInfinity() ? 2 : (rn(t, r), 0)
    },
    publicKeyTweakAdd(t, e, i) {
      const r = en(e)
      if (null === r) return 1
      if ((i = new tn(i)).cmp(Qr.n) >= 0) return 2
      const n = r.getPublic().add(Qr.g.mul(i))
      return n.isInfinity() ? 2 : (rn(t, n), 0)
    },
    publicKeyTweakMul(t, e, i) {
      const r = en(e)
      return null === r
        ? 1
        : (i = new tn(i)).cmp(Qr.n) >= 0 || i.isZero()
        ? 2
        : (rn(t, r.getPublic().mul(i)), 0)
    },
    signatureNormalize(t) {
      const e = new tn(t.subarray(0, 32)),
        i = new tn(t.subarray(32, 64))
      return e.cmp(Qr.n) >= 0 || i.cmp(Qr.n) >= 0
        ? 1
        : (1 === i.cmp(Yr.nh) &&
            t.set(Qr.n.sub(i).toArrayLike(Uint8Array, 'be', 32), 32),
          0)
    },
    signatureExport(t, e) {
      const i = e.subarray(0, 32),
        r = e.subarray(32, 64)
      if (new tn(i).cmp(Qr.n) >= 0) return 1
      if (new tn(r).cmp(Qr.n) >= 0) return 1
      const { output: n } = t
    ...
    signatureImport(t, e) {
      ...
      let a = new tn(n)
      a.cmp(Qr.n) >= 0 && (a = new tn(0))
      let o = new tn(e.subarray(6 + i))
      return (
        o.cmp(Qr.n) >= 0 && (o = new tn(0)),
    ...
    ecdsaSign(t, e, i, r, n) {
      ...
      const s = new tn(i)
      if (s.cmp(Qr.n) >= 0 || s.isZero()) return 1
      let a
      try {
        a = Yr.sign(e, i, { canonical: !0, k: n, pers: r })
      } catch (t) {
        return 1
      }
      return (
    ...
    ecdsaVerify(t, e, i) {
      const r = { r: t.subarray(0, 32), s: t.subarray(32, 64) },
        n = new tn(r.r),
        s = new tn(r.s)
      if (n.cmp(Qr.n) >= 0 || s.cmp(Qr.n) >= 0) return 1
      if (1 === s.cmp(Yr.nh) || n.isZero() || s.isZero()) return 3
      const a = en(i)
      if (null === a) return 2
      const o = a.getPublic()
      return Yr.verify(e, r, o) ? 0 : 3
    },
    ecdsaRecover(t, e, i, r) {
      const n = { r: e.slice(0, 32), s: e.slice(32, 64) },
        s = new tn(n.r),
        a = new tn(n.s)
      if (s.cmp(Qr.n) >= 0 || a.cmp(Qr.n) >= 0) return 1
      if (s.isZero() || a.isZero()) return 2
      let o
      try {
        o = Yr.recoverPubKey(r, n, i)
      } catch (t) {
        return 2
      }
      return rn(t, o), 0
    ...
    ecdh(t, e, i, r, n, s, a) {
      ...
      if (null === o) return 1
      const u = new tn(i)
      if (u.cmp(Qr.n) >= 0 || u.isZero()) return 2
      const h = o.getPublic().mul(u)
      if (void 0 === n) {
        const e = h.encode(null, !0),
          i = Yr.hash().update(e).digest()
  ...
  on = h.randomBytes,
  un = /*#__PURE__*/ Object.defineProperty(
    {
  ...
  hn = bt(function (t, e) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      (e.createPrivateKey = function () {
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (e) {
            switch (e.label) {
              case 0:
                return [4, un.getRandomBytes(32)]
              case 1:
                return (t = e.sent()), an.privateKeyVerify(t) ? [2, t] : [3, 0]
              case 2:
                return [2]
            }
          })
      ...
      (e.createPrivateKeySync = function () {
        for (;;) {
          var t = un.getRandomBytesSync(32)
          if (an.privateKeyVerify(t)) return t
        }
      }),
      (function (t) {
  ...
  fn = bt(function (t, e) {
    ...
    ;(e.setLengthLeft = function (t, e) {
      return (0, dn.assertIsBuffer)(t), i(t, e, !1)
    }),
      (e.setLengthRight = function (t, e) {
        return (0, dn.assertIsBuffer)(t), i(t, e, !0)
      })
    const r = function (t) {
      let e = t[0]
    ...
    ;(e.unpadBuffer = function (t) {
      return (0, dn.assertIsBuffer)(t), r(t)
    }),
      (e.unpadArray = function (t) {
        return (0, dn.assertIsArray)(t), r(t)
      }),
      (e.unpadHexString = function (t) {
        return (
          (0, dn.assertIsHexString)(t), (t = (0, ln.stripHexPrefix)(t)), r(t)
        )
      }),
  ...
  cn = /*#__PURE__*/ Object.defineProperty(
    {
...
var yn = o.Buffer,
  bn = d.inspect,
  wn = (bn && bn.custom) || 'inspect'
function vn(t, e, i) {
  yn.prototype.copy.call(t, e, i)
}
var Mn =
  /*#__PURE__*/
  (function () {
    ...
    return (
      (e = [
        ...
        },
        {
          key: 'concat',
          value: function (t) {
            if (0 === this.length) return yn.alloc(0)
            for (var e = yn.allocUnsafe(t >>> 0), i = this.head, r = 0; i; )
              vn(i.data, e, r), (r += i.data.length), (i = i.next)
            return e
          }
        },
        {
            ...
            return bn(
              ...
              (function (t) {
                for (var e = 1; e < arguments.length; e++) {
                  ...
                  e % 2
                    ? mn(Object(i), !0).forEach(function (e) {
                        gn(t, e, i[e])
                      })
                    ...
                    : mn(Object(i)).forEach(function (e) {
...
function kn(t, e, i) {
  ...
  ;(r.prototype.name = i.name), (r.prototype.code = t), (Rn[t] = r)
}
function In(t, e) {
  if (Array.isArray(t)) {
    const i = t.length
...
kn(
  ...
  kn('ERR_STREAM_PUSH_AFTER_EOF', 'stream.push() after EOF'),
  kn('ERR_METHOD_NOT_IMPLEMENTED', function (t) {
    return 'The ' + t + ' method is not implemented'
  }),
  kn('ERR_STREAM_PREMATURE_CLOSE', 'Premature close'),
  kn('ERR_STREAM_DESTROYED', function (t) {
    return 'Cannot call ' + t + ' after a stream was destroyed'
  }),
  kn('ERR_MULTIPLE_CALLBACK', 'Callback called multiple times'),
  kn('ERR_STREAM_CANNOT_PIPE', 'Cannot pipe, not readable'),
  kn('ERR_STREAM_WRITE_AFTER_END', 'write after end'),
  kn(
  ...
  kn('ERR_STREAM_UNSHIFT_AFTER_END_EVENT', 'stream.unshift() after end event')
var Bn,
  On = { codes: Rn },
  Pn = On.codes.ERR_INVALID_OPT_VALUE,
  Cn = function (t, e, i, r) {
    ...
    if (null != n) {
      if (!isFinite(n) || Math.floor(n) !== n || n < 0)
        throw new Pn(r ? i : 'highWaterMark', n)
      return Math.floor(n)
    }
...
var Un,
  qn = { deprecate: Nn },
  jn = o.Buffer,
  zn = yt.Uint8Array || function () {},
  Wn = Cn,
  $n = On.codes,
  Hn = $n.ERR_INVALID_ARG_TYPE,
  Gn = $n.ERR_METHOD_NOT_IMPLEMENTED,
  Zn = $n.ERR_MULTIPLE_CALLBACK,
  Kn = $n.ERR_STREAM_CANNOT_PIPE,
  Vn = $n.ERR_STREAM_DESTROYED,
  Jn = $n.ERR_STREAM_NULL_VALUES,
  Xn = $n.ERR_STREAM_WRITE_AFTER_END,
  Yn = $n.ERR_UNKNOWN_ENCODING,
  Qn = En
function ts() {}
function es(t, e, i) {
  ;(Bn = Bn || Ln),
    'boolean' != typeof i && (i = e instanceof Bn),
    (this.objectMode = !!(t = t || {}).objectMode),
    i && (this.objectMode = this.objectMode || !!t.writableObjectMode),
    (this.highWaterMark = Wn(this, t, 'writableHighWaterMark', i)),
    (this.finalCalled = !1),
    (this.needDrain = !1),
    (this.ending = !1),
    (this.ended = !1),
    ...
    (this.onwrite = function (t) {
      !(function (t, e) {
        var i = t._writableState,
          r = i.sync,
          n = i.writecb
        if ('function' != typeof n) throw new Zn()
        if (
          ((function (t) {
            ;(t.writing = !1),
              (t.writecb = null),
          ...
          var s = as(i) || t.destroyed
          s || i.corked || i.bufferProcessing || !i.bufferedRequest || ss(t, i),
            r ? process.nextTick(ns, t, i, s, n) : ns(t, i, s, n)
        }
      })(e, t)
    }),
    (this.writecb = null),
    ...
    (this.corkedRequestsFree = new Fn(this))
}
function is(t) {
  var e = this instanceof (Bn = Bn || Ln)
  if (!e && !Un.call(is, this)) return new is(t)
  ;(this._writableState = new es(t, this, e)),
    (this.writable = !0),
    t &&
...
function rs(t, e, i, r, n, s, a) {
  ;(e.writelen = r),
    (e.writecb = a),
    (e.writing = !0),
    (e.sync = !0),
    e.destroyed
      ? e.onwrite(new Vn('write'))
      : i
...
function ss(t, e) {
  ...
  if (t._writev && i && i.next) {
    ...
    ;(r.allBuffers = a),
      rs(t, e, !0, e.length, r, '', n.finish),
      e.pendingcb++,
      (e.lastBufferedRequest = null),
      n.next
        ? ((e.corkedRequestsFree = n.next), (n.next = null))
        : (e.corkedRequestsFree = new Fn(e)),
      (e.bufferedRequestCount = 0)
  } else {
    for (; i; ) {
      var o = i.chunk
      if (
        (rs(t, e, !1, e.objectMode ? 1 : o.length, o, i.encoding, i.callback),
        (i = i.next),
    ...
    ((function (t, e) {
      e.prefinished ||
        ...
        ('function' != typeof t._final || e.destroyed
          ...
          : (e.pendingcb++, (e.finalCalled = !0), process.nextTick(os, t, e)))
    })(t, e),
...
Be(is, pn),
  (es.prototype.getBuffer = function () {
    for (var t = this.bufferedRequest, e = []; t; ) e.push(t), (t = t.next)
    return e
  }),
  (function () {
    try {
      Object.defineProperty(es.prototype, 'buffer', {
        get: qn.deprecate(
          function () {
  ...
  'function' == typeof Function.prototype[Symbol.hasInstance]
    ? ((Un = Function.prototype[Symbol.hasInstance]),
      Object.defineProperty(is, Symbol.hasInstance, {
        value: function (t) {
          return (
            !!Un.call(this, t) ||
            (this === is && t && t._writableState instanceof es)
          )
        }
      }))
    : (Un = function (t) {
  ...
  (is.prototype.pipe = function () {
    Qn(this, new Kn())
  }),
  (is.prototype.write = function (t, e, i) {
    var r,
      n = this._writableState,
      s = !1,
      a = !n.objectMode && (jn.isBuffer((r = t)) || r instanceof zn)
    return (
      a &&
        !jn.isBuffer(t) &&
        (t = (function (t) {
      ...
      'function' != typeof i && (i = ts),
      n.ending
        ? (function (t, e) {
            var i = new Xn()
            Qn(t, i), process.nextTick(e, i)
          })(this, i)
        : (a ||
            (function (t, e, i, r) {
              var n
              return (
                null === i
                  ...
                  : 'string' == typeof i ||
                    e.objectMode ||
                    (n = new Hn('chunk', ['string', 'Buffer'], i)),
                !n || (Qn(t, n), process.nextTick(r, n), !1)
              )
            })(this, n, t, i)) &&
          (n.pendingcb++,
          (s = (function (t, e, i, r, n, s) {
            ...
            } else rs(t, e, !1, o, r, n, s)
            return u
          })(this, n, a, t, e, i))),
      s
    )
  }),
  (is.prototype.cork = function () {
    this._writableState.corked++
  }),
  (is.prototype.uncork = function () {
  ...
  (is.prototype.setDefaultEncoding = function (t) {
    if (
  ...
  Object.defineProperty(is.prototype, 'writableBuffer', {
    enumerable: !1,
    get: function () {
      return this._writableState && this._writableState.getBuffer()
    }
  }),
  Object.defineProperty(is.prototype, 'writableHighWaterMark', {
    enumerable: !1,
    get: function () {
      return this._writableState.highWaterMark
    }
  }),
  (is.prototype._write = function (t, e, i) {
    i(new Gn('_write()'))
  }),
  (is.prototype._writev = null),
  (is.prototype.end = function (t, e, i) {
  ...
  Object.defineProperty(is.prototype, 'writableLength', {
    enumerable: !1,
    get: function () {
      return this._writableState.length
    }
  }),
  Object.defineProperty(is.prototype, 'destroyed', {
    enumerable: !1,
    get: function () {
  ...
  (is.prototype.destroy = Tn),
  (is.prototype._undestroy = xn),
  (is.prototype._destroy = function (t, e) {
    e(t)
  })
var hs = Ws,
  ls =
  ...
  ds = ms
Be(ms, hs)
for (var fs = ls(Dn.prototype), cs = 0; cs < fs.length; cs++) {
  var ps = fs[cs]
  ms.prototype[ps] || (ms.prototype[ps] = Dn.prototype[ps])
}
function ms(t) {
  ...
  hs.call(this, t),
    ...
    t &&
      ...
      !1 === t.allowHalfOpen &&
        ((this.allowHalfOpen = !1), this.once('end', gs)))
}
function gs() {
  this._writableState.ended || process.nextTick(ys, this)
}
function ys(t) {
  t.end()
}
Object.defineProperty(ms.prototype, 'writableHighWaterMark', {
  enumerable: !1,
  get: function () {
    return this._writableState.highWaterMark
  }
}),
  Object.defineProperty(ms.prototype, 'writableBuffer', {
    enumerable: !1,
    get: function () {
      return this._writableState && this._writableState.getBuffer()
    }
  }),
  Object.defineProperty(ms.prototype, 'writableLength', {
    enumerable: !1,
    get: function () {
      return this._writableState.length
    }
  }),
  Object.defineProperty(ms.prototype, 'destroyed', {
    enumerable: !1,
    get: function () {
      return (
...
var bs = On.codes.ERR_STREAM_PREMATURE_CLOSE
function ws() {}
var vs,
  Ms = function t(e, i, r) {
    ...
    var n = i.readable || (!1 !== i.readable && e.readable),
      ...
      f = function () {
        var t
        return n && !h
          ? ((e._readableState && e._readableState.ended) || (t = new bs()),
            r.call(e, t))
          : s && !o
          ? ((e._writableState && e._writableState.ended) || (t = new bs()),
            r.call(e, t))
          : void 0
      },
      c = function () {
...
var Ss = Symbol('lastResolve'),
  _s = Symbol('lastReject'),
  Ts = Symbol('error'),
  xs = Symbol('ended'),
  Es = Symbol('lastPromise'),
  Rs = Symbol('handlePromise'),
  ks = Symbol('stream')
function Is(t, e) {
...
function Bs(t) {
  ...
  if (null !== e) {
    var i = t[ks].read()
    null !== i && ((t[Es] = null), (t[Ss] = null), (t[_s] = null), e(Is(i, !1)))
  }
}
function Os(t) {
  process.nextTick(Bs, t)
}
var Ps = Object.getPrototypeOf(function () {}),
  Cs = Object.setPrototypeOf(
    (As(
      (vs = {
        ...
        next: function () {
          ...
          if (this[xs]) return Promise.resolve(Is(void 0, !0))
          if (this[ks].destroyed)
            return new Promise(function (e, i) {
              process.nextTick(function () {
                t[Ts] ? i(t[Ts]) : e(Is(void 0, !0))
              })
            })
          var i,
            r = this[Es]
          if (r)
            ...
            var n = this[ks].read()
            if (null !== n) return Promise.resolve(Is(n, !1))
            i = new Promise(this[Rs])
          }
          return (this[Es] = i), i
        }
      }),
    ...
    As(vs, 'return', function () {
      var t = this
      return new Promise(function (e, i) {
        t[ks].destroy(null, function (t) {
          t ? i(t) : e(Is(void 0, !0))
        })
      })
    }),
  ...
  Ns = function (t) {
    var e,
      i = Object.create(
        Cs,
        (As((e = {}), ks, { value: t, writable: !0 }),
        As(e, Ss, { value: null, writable: !0 }),
        As(e, _s, { value: null, writable: !0 }),
        As(e, Ts, { value: null, writable: !0 }),
        As(e, xs, { value: t._readableState.endEmitted, writable: !0 }),
        As(e, Rs, {
          value: function (t, e) {
            var r = i[ks].read()
            r
              ? ((i[Es] = null), (i[Ss] = null), (i[_s] = null), t(Is(r, !1)))
              : ((i[Ss] = t), (i[_s] = e))
          },
          writable: !0
        }),
    ...
    return (
      ...
      Ms(t, function (t) {
        if (t && 'ERR_STREAM_PREMATURE_CLOSE' !== t.code) {
          ...
          return (
            null !== e &&
              ((i[Es] = null), (i[Ss] = null), (i[_s] = null), e(t)),
            void (i[Ts] = t)
          )
        }
        var r = i[Ss]
        null !== r &&
          ((i[Es] = null), (i[Ss] = null), (i[_s] = null), r(Is(void 0, !0))),
          (i[xs] = !0)
      }),
      t.on('readable', Os.bind(null, i)),
      i
    )
  }
function Ls(t, e, i, r, n, s, a) {
  try {
    var o = t[s](a),
      u = o.value
  } catch (t) {
    ...
    var n = new t(
        (function (t) {
          for (var e = 1; e < arguments.length; e++) {
            var i = null != arguments[e] ? arguments[e] : {}
            e % 2
              ? Fs(Object(i), !0).forEach(function (e) {
                  Us(t, e, i[e])
                })
              : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i))
              : Fs(Object(i)).forEach(function (e) {
                  Object.defineProperty(
                    t,
                    e,
                    Object.getOwnPropertyDescriptor(i, e)
...
var Ks,
  ...
  Xs = Cn,
  Ys = On.codes,
  Qs = Ys.ERR_INVALID_ARG_TYPE,
  ta = Ys.ERR_STREAM_PUSH_AFTER_EOF,
  ea = Ys.ERR_METHOD_NOT_IMPLEMENTED,
  ia = Ys.ERR_STREAM_UNSHIFT_AFTER_END_EVENT
Be(aa, pn)
var ra = En,
  na = ['error', 'close', 'destroy', 'pause', 'resume']
function sa(t, e, i) {
  ;(qs = qs || Ln),
    'boolean' != typeof i && (i = e instanceof qs),
    (this.objectMode = !!(t = t || {}).objectMode),
    i && (this.objectMode = this.objectMode || !!t.readableObjectMode),
    (this.highWaterMark = Xs(this, t, 'readableHighWaterMark', i)),
    (this.buffer = new Mn()),
    (this.length = 0),
    (this.pipes = null),
    (this.pipesCount = 0),
    ...
    (this.encoding = null),
    t.encoding &&
      (Ks || (Ks = f.StringDecoder),
      (this.decoder = new Ks(t.encoding)),
      (this.encoding = t.encoding))
}
function aa(t) {
  if (((qs = qs || Ln), !(this instanceof aa))) return new aa(t)
  ;(this._readableState = new sa(t, this, this instanceof qs)),
    (this.readable = !0),
    t &&
...
function oa(t, e, i, r, n) {
  ...
  if (null === e)
        ...
        if (($s('onEofChunk'), !e.ended)) {
          ...
          ;(e.ended = !0),
            e.sync
              ? la(t)
              : ((e.needReadable = !1),
                e.emittedReadable || ((e.emittedReadable = !0), da(t)))
        }
      })(t, a)
  else if (
    (n ||
      (s = (function (t, e) {
        ...
        return (
          Gs.isBuffer((r = e)) ||
            ...
            void 0 === e ||
            t.objectMode ||
            (i = new Qs('chunk', ['string', 'Buffer', 'Uint8Array'], e)),
          i
        )
      })(a, e)),
    s)
    ...
    if (
      ('string' == typeof e ||
        a.objectMode ||
        Object.getPrototypeOf(e) === Gs.prototype ||
        (e = (function (t) {
          return Gs.from(t)
        })(e)),
      r)
    )
      a.endEmitted ? ra(t, new ia()) : ua(t, a, e, !0)
    else if (a.ended) ra(t, new ta())
    else {
      if (a.destroyed) return !1
      ;(a.reading = !1),
        a.decoder && !i
          ? ((e = a.decoder.write(e)),
            a.objectMode || 0 !== e.length ? ua(t, a, e, !1) : fa(t, a))
          : ua(t, a, e, !1)
    }
  else r || ((a.reading = !1), fa(t, a))
...
function fa(t, e) {
  e.readingMore || ((e.readingMore = !0), process.nextTick(ca, t, e))
}
function ca(t, e) {
  for (
    ;
    ...
    var i = e.length
    if (($s('maybeReadMore read 0'), t.read(0), i === e.length)) break
  }
  e.readingMore = !1
}
function pa(t) {
...
function wa(t) {
  ...
  $s('endReadable', e.endEmitted),
    e.endEmitted || ((e.ended = !0), process.nextTick(va, e, t))
}
function va(t, e) {
  if (
...
Object.defineProperty(aa.prototype, 'destroyed', {
  enumerable: !1,
  get: function () {
  ...
  (aa.prototype.destroy = Tn),
  (aa.prototype._undestroy = xn),
  (aa.prototype._destroy = function (t, e) {
    e(t)
  }),
  ...
  (aa.prototype.unshift = function (t) {
    return oa(this, t, null, !0, !1)
  }),
  (aa.prototype.isPaused = function () {
    return !1 === this._readableState.flowing
  }),
  (aa.prototype.setEncoding = function (t) {
    Ks || (Ks = f.StringDecoder)
    var e = new Ks(t)
  ...
  (aa.prototype.read = function (t) {
    ...
    if (
      ...
      return (
        ...
        0 === e.length && e.ended ? wa(this) : la(this),
        null
      )
    if (0 === (t = ha(t, e)) && e.ended) return 0 === e.length && wa(this), null
    var r,
      n = e.needReadable
    return (
      $s('need readable', n),
  ...
  (aa.prototype._read = function (t) {
    ra(this, new ea('_read()'))
  }),
  (aa.prototype.pipe = function (t, e) {
    var i = this,
      r = this._readableState
    switch (r.pipesCount) {
      case 0:
    ...
    ;(r.pipesCount += 1), $s('pipe count=%d opts=%j', r.pipesCount, e)
    var n =
    ...
    var a = (function (t) {
      return function () {
        ...
        $s('pipeOnDrain', e.awaitDrain),
          ...
          0 === e.awaitDrain && Hs(t, 'data') && ((e.flowing = !0), ya(t))
      }
    })(i)
    t.on('drain', a)
    var o = !1
      ...
      $s('dest.write', n),
        !1 === n &&
          (((1 === r.pipesCount && r.pipes === t) ||
            (r.pipesCount > 1 && -1 !== Ma(r.pipes, t))) &&
            !o &&
            ($s('false write response, pause', r.awaitDrain), r.awaitDrain++),
          i.pause())
    }
    function h(e) {
      $s('onerror', e),
    ...
    function d() {
      $s('onfinish'), t.removeListener('close', l), f()
    }
    function f() {
      $s('unpipe'), i.unpipe(t)
    }
    return (
      ...
      t.once('finish', d),
      t.emit('pipe', i),
      r.flowing || ($s('pipe resume'), i.resume()),
      t
    )
  }),
  (aa.prototype.unpipe = function (t) {
    var e = this._readableState,
      i = { hasUnpiped: !1 }
  ...
  (aa.prototype.addListener = aa.prototype.on =
    function (t, e) {
      var i = pn.prototype.on.call(this, t, e),
        r = this._readableState
      return (
        'data' === t
          ...
          : 'readable' === t &&
            (r.endEmitted ||
              ...
              r.length ? la(this) : r.reading || process.nextTick(ma, this))),
        i
      )
    }),
  (aa.prototype.removeListener = function (t, e) {
    var i = pn.prototype.removeListener.call(this, t, e)
    return 'readable' === t && process.nextTick(pa, this), i
  }),
  (aa.prototype.removeAllListeners = function (t) {
    var e = pn.prototype.removeAllListeners.apply(this, arguments)
    return ('readable' !== t && void 0 !== t) || process.nextTick(pa, this), e
  }),
  (aa.prototype.resume = function () {
    ...
    return (
      t.flowing ||
        ...
        (function (t, e) {
          e.resumeScheduled ||
            ((e.resumeScheduled = !0), process.nextTick(ga, t, e))
        })(this, t)),
      (t.paused = !1),
      this
    )
  ...
  (aa.prototype.wrap = function (t) {
    ...
    for (var s = 0; s < na.length; s++) t.on(na[s], this.emit.bind(this, na[s]))
    return (
      (this._read = function (e) {
        $s('wrapped _read', e), r && ((r = !1), t.resume())
      }),
      this
    )
  }),
  'function' == typeof Symbol &&
    (aa.prototype[Symbol.asyncIterator] = function () {
      return void 0 === Vs && (Vs = Ns), Vs(this)
    }),
  Object.defineProperty(aa.prototype, 'readableHighWaterMark', {
    enumerable: !1,
    get: function () {
      return this._readableState.highWaterMark
    }
  }),
  Object.defineProperty(aa.prototype, 'readableBuffer', {
    enumerable: !1,
    get: function () {
      return this._readableState && this._readableState.buffer
    }
  }),
  Object.defineProperty(aa.prototype, 'readableFlowing', {
    enumerable: !1,
    get: function () {
  ...
  (aa._fromList = ba),
  Object.defineProperty(aa.prototype, 'readableLength', {
    enumerable: !1,
    get: function () {
  ...
  'function' == typeof Symbol &&
    (aa.from = function (t, e) {
      return void 0 === Js && (Js = zs), Js(aa, t, e)
    })
var Aa = ka,
  Sa = On.codes,
  _a = Sa.ERR_METHOD_NOT_IMPLEMENTED,
  Ta = Sa.ERR_MULTIPLE_CALLBACK,
  xa = Sa.ERR_TRANSFORM_ALREADY_TRANSFORMING,
  Ea = Sa.ERR_TRANSFORM_WITH_LENGTH_0
function Ra(t, e) {
  var i = this._transformState
  i.transforming = !1
  var r = i.writecb
  if (null === r) return this.emit('error', new Ta())
...
function Ba(t, e, i) {
  ...
  if ((null != i && t.push(i), t._writableState.length)) throw new Ea()
  if (t._transformState.transforming) throw new xa()
  return t.push(null)
}
Be(ka, Ln),
  (ka.prototype.push = function (t, e) {
    return (
      ...
      Ln.prototype.push.call(this, t, e)
    )
  }),
  (ka.prototype._transform = function (t, e, i) {
    i(new _a('_transform()'))
  }),
  (ka.prototype._write = function (t, e, i) {
  ...
  (ka.prototype._destroy = function (t, e) {
    Ln.prototype._destroy.call(this, t, function (t) {
      e(t)
    })
  })
var Oa,
...
Be(Ca, Aa),
  (Ca.prototype._transform = function (t, e, i) {
    i(null, t)
  })
var Na = On.codes,
  La = Na.ERR_MISSING_ARGS,
  Da = Na.ERR_STREAM_DESTROYED
function Fa(t) {
  if (t) throw t
}
function Ua(t, e, i, r) {
  ...
  t.on('close', function () {
    ...
    void 0 === Oa && (Oa = Ms),
    Oa(t, { readable: e, writable: i }, function (t) {
      if (t) return r(t)
      ;(n = !0), r()
    })
  var s = !1
...
function za(t) {
  return t.length ? ('function' != typeof t[t.length - 1] ? Fa : t.pop()) : Fa
}
var Wa = function () {
    ...
    if ((Array.isArray(e[0]) && (e = e[0]), e.length < 2))
      throw new La('streams')
    var s = e.map(function (t, i) {
      var a = i < e.length - 1
      return Ua(t, a, i > 0, function (t) {
        r || (r = t), t && s.forEach(qa), a || (s.forEach(qa), n(r))
      })
    })
    return e.reduce(ja)
  },
  $a = bt(function (t, e) {
    'disable' === process.env.READABLE_STREAM && l
      ? ((t.exports = l.Readable),
        Object.assign(t.exports, l),
        (t.exports.Stream = l))
      : (((e = t.exports = hs).Stream = l || e),
        (e.Readable = e),
        (e.Writable = Dn),
        (e.Duplex = Ln),
        (e.Transform = Aa),
...
;(Qa.prototype.initialize = function (t, e) {
  for (let t = 0; t < 50; ++t) this.state[t] = 0
  ;(this.blockSize = t / 8), (this.count = 0), (this.squeezing = !1)
}),
  (Qa.prototype.absorb = function (t) {
    for (let e = 0; e < t.length; ++e)
      (this.state[~~(this.count / 4)] ^= t[e] << ((this.count % 4) * 8)),
        (this.count += 1),
        this.count === this.blockSize && (Ya(this.state), (this.count = 0))
  }),
  (Qa.prototype.absorbLastFewBits = function (t) {
    ;(this.state[~~(this.count / 4)] ^= t << ((this.count % 4) * 8)),
      0 != (128 & t) && this.count === this.blockSize - 1 && Ya(this.state),
  ...
  (Qa.prototype.squeeze = function (t) {
...
var to = Va(Qa),
  ...
  io = cn,
  ro = io.createHashFunction(function () {
    return eo('keccak224')
  }),
  no = io.createHashFunction(function () {
    return eo('keccak256')
  }),
  so = io.createHashFunction(function () {
    return eo('keccak384')
  }),
  ao = io.createHashFunction(function () {
    return eo('keccak512')
  }),
  oo = h.createHash,
  uo = /*#__PURE__*/ Object.defineProperty(
    { keccak224: ro, keccak256: no, keccak384: so, keccak512: ao },
    '__esModule',
    { value: !0 }
  ),
  ho = bt(function (t, e) {
    Object.defineProperty(e, '__esModule', { value: !0 }),
      ...
      (e.keccak = function (t, e = 256) {
        switch (((0, dn.assertIsBuffer)(t), e)) {
          case 224:
            return (0, uo.keccak224)(t)
          case 256:
            return (0, uo.keccak256)(t)
          case 384:
            return (0, uo.keccak384)(t)
          case 512:
            return (0, uo.keccak512)(t)
          default:
      ...
      (e.keccakFromString = function (t, i = 256) {
        ;(0, dn.assertIsString)(t)
        const r = Buffer.from(t, 'utf8')
        return (0, e.keccak)(r, i)
      }),
      (e.keccakFromHexString = function (t, i = 256) {
        return (
          (0, dn.assertIsHexString)(t), (0, e.keccak)((0, fn.toBuffer)(t), i)
        )
      }),
      (e.keccakFromArray = function (t, i = 256) {
        return (0, dn.assertIsArray)(t), (0, e.keccak)((0, fn.toBuffer)(t), i)
      })
    const i = function (t) {
      return (t = (0, fn.toBuffer)(t)), oo('sha256').update(t).digest()
    }
    ;(e.sha256 = function (t) {
      return (0, dn.assertIsBuffer)(t), i(t)
    }),
      (e.sha256FromString = function (t) {
        return (0, dn.assertIsString)(t), i(t)
      }),
      (e.sha256FromArray = function (t) {
        return (0, dn.assertIsArray)(t), i(t)
      })
    const r = function (t, e) {
      t = (0, fn.toBuffer)(t)
      const i = oo('rmd160').update(t).digest()
      return !0 === e ? (0, fn.setLengthLeft)(i, 32) : i
    }
    ;(e.ripemd160 = function (t, e) {
      return (0, dn.assertIsBuffer)(t), r(t, e)
    }),
      (e.ripemd160FromString = function (t, e) {
        return (0, dn.assertIsString)(t), r(t, e)
      }),
      (e.ripemd160FromArray = function (t, e) {
        return (0, dn.assertIsArray)(t), r(t, e)
      }),
      (e.rlphash = function (t) {
        return (0, e.keccak)(Nt.rlp.encode(t))
      })
  }),
  lo = bt(function (t, e) {
    function i(t) {
      return (0, fn.unpadBuffer)(t.toArrayLike(Buffer))
    }
    var r
    Object.defineProperty(e, '__esModule', { value: !0 }),
      (e.toType =
      ...
      (e.toType = function (t, e) {
        ...
        const i = (0, fn.toBuffer)(t)
        if (e === r.Buffer) return i
        if (e === r.BN) return new Nt.BN(i)
        if (e === r.Number) {
          const t = new Nt.BN(i),
            e = new Nt.BN(Number.MAX_SAFE_INTEGER.toString())
          if (t.gt(e))
            throw new Error(
  ...
  co = bt(function (t, e) {
    ...
    class n {
      ...
      static fromAccountData(t) {
        ...
        return new n(
          e ? new Nt.BN((0, fn.toBuffer)(e)) : void 0,
          i ? new Nt.BN((0, fn.toBuffer)(i)) : void 0,
          r ? (0, fn.toBuffer)(r) : void 0,
          s ? (0, fn.toBuffer)(s) : void 0
        )
      }
      static fromRlpSerializedAccount(t) {
        const e = Nt.rlp.decode(t)
        if (!Array.isArray(e))
      ...
      static fromValuesArray(t) {
        const [e, i, r, s] = t
        return new n(new Nt.BN(e), new Nt.BN(i), r, s)
      }
      _validate() {
        if (this.nonce.lt(new Nt.BN(0)))
          throw new Error('nonce must be greater than zero')
        if (this.balance.lt(new Nt.BN(0)))
      ...
      raw() {
        return [
          (0, lo.bnToUnpaddedBuffer)(this.nonce),
          (0, lo.bnToUnpaddedBuffer)(this.balance),
          this.stateRoot,
          this.codeHash
        ]
      }
      serialize() {
        return Nt.rlp.encode(this.raw())
      }
      isContract() {
        return !this.codeHash.equals(Lt.KECCAK256_NULL)
      }
      isEmpty() {
        return (
          this.balance.isZero() &&
          this.nonce.isZero() &&
          this.codeHash.equals(Lt.KECCAK256_NULL)
        )
      }
    }
    ;(e.Account = n),
      ...
      (e.toChecksumAddress = function (t, e) {
        ;(0, dn.assertIsHexString)(t)
        const i = (0, ln.stripHexPrefix)(t).toLowerCase()
        let r = ''
        e && (r = (0, lo.toType)(e, lo.TypeOutput.BN).toString() + '0x')
        const n = (0, ho.keccakFromString)(r + i).toString('hex')
        let s = '0x'
      ...
      (e.generateAddress = function (t, e) {
        ;(0, dn.assertIsBuffer)(t), (0, dn.assertIsBuffer)(e)
        const i = new Nt.BN(e)
        return i.isZero()
          ? (0, ho.rlphash)([t, null]).slice(-20)
          : (0, ho.rlphash)([t, Buffer.from(i.toArray())]).slice(-20)
      }),
      (e.generateAddress2 = function (t, e, i) {
        return (
          (0, dn.assertIsBuffer)(t),
          (0, dn.assertIsBuffer)(e),
          (0, dn.assertIsBuffer)(i),
      ...
      (e.isValidPrivate = function (t) {
        return (0, fo.privateKeyVerify)(t)
      }),
      (e.isValidPublic = function (t, e = !1) {
        return (
          (0, dn.assertIsBuffer)(t),
          64 === t.length
            ? (0, fo.publicKeyVerify)(Buffer.concat([Buffer.from([4]), t]))
            : !!e && (0, fo.publicKeyVerify)(t)
        )
      }),
      (e.pubToAddress = function (t, e = !1) {
        return (
          ...
          e &&
            64 !== t.length &&
            (t = Buffer.from((0, fo.publicKeyConvert)(t, !1).slice(1))),
          (0, r.default)(64 === t.length),
          (0, ho.keccak)(t).slice(-20)
        )
      }),
      ...
      (e.privateToPublic = function (t) {
        return (
          (0, dn.assertIsBuffer)(t),
          Buffer.from((0, fo.publicKeyCreate)(t, !1)).slice(1)
        )
      }),
      ...
      (e.zeroAddress = function () {
        const t = (0, fn.zeros)(20)
        return (0, fn.bufferToHex)(t)
      }),
  ...
  po = bt(function (t, e) {
    ...
    class n {
      ...
      static zero() {
        return new n((0, fn.zeros)(20))
      }
      static fromString(t) {
        return (
          (0, r.default)((0, co.isValidAddress)(t), 'Invalid address'),
          new n((0, fn.toBuffer)(t))
        )
      }
      static fromPublicKey(t) {
        ;(0, r.default)(Buffer.isBuffer(t), 'Public key should be Buffer')
        const e = (0, co.pubToAddress)(t)
        return new n(e)
      }
      static fromPrivateKey(t) {
        ;(0, r.default)(Buffer.isBuffer(t), 'Private key should be Buffer')
        const e = (0, co.privateToAddress)(t)
        return new n(e)
      }
      static generate(t, e) {
        return (
          (0, r.default)(Nt.BN.isBN(e)),
          new n((0, co.generateAddress)(t.buf, e.toArrayLike(Buffer)))
        )
      }
      static generate2(t, e, i) {
        return (
          ...
          new n((0, co.generateAddress2)(t.buf, e, i))
        )
      }
      equals(t) {
      ...
      isPrecompileOrSystemAddress() {
        const t = new Nt.BN(this.buf),
          e = new Nt.BN(0),
          i = new Nt.BN('ffff', 'hex')
  ...
  mo = bt(function (t, e) {
    function i(t, e) {
      const i = (0, lo.toType)(t, lo.TypeOutput.BN)
      if (!e) return i.subn(27)
      const r = (0, lo.toType)(e, lo.TypeOutput.BN)
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      ...
      (e.ecsign = function (t, e, i) {
        const { signature: r, recid: n } = (0, fo.ecdsaSign)(t, e),
        ...
        return {
          r: s,
          s: a,
          v: (0, lo.toType)(i, lo.TypeOutput.BN)
            .muln(2)
            .addn(35)
            .addn(n)
            .toArrayLike(Buffer)
      ...
      (e.ecrecover = function (t, e, n, s, a) {
        const o = Buffer.concat(
            [(0, fn.setLengthLeft)(n, 32), (0, fn.setLengthLeft)(s, 32)],
            64
          ),
          u = i(e, a)
        if (!r(u)) throw new Error('Invalid signature v value')
        const h = (0, fo.ecdsaRecover)(o, u.toNumber(), t)
        return Buffer.from((0, fo.publicKeyConvert)(h, !1).slice(1))
      }),
      (e.toRpcSig = function (t, e, n, s) {
        if (!r(i(t, s))) throw new Error('Invalid signature v value')
        return (0, fn.bufferToHex)(
          Buffer.concat([
            (0, fn.setLengthLeft)(e, 32),
            (0, fn.setLengthLeft)(n, 32),
            (0, fn.toBuffer)(t)
          ])
        )
      }),
      (e.toCompactSig = function (t, e, n, s) {
        if (!r(i(t, s))) throw new Error('Invalid signature v value')
        const a = (0, lo.toType)(t, lo.TypeOutput.Number)
        let o = n
        return (
          ((a > 28 && a % 2 == 1) || 1 === a || 28 === a) &&
          ...
          (0, fn.bufferToHex)(
            Buffer.concat([
              (0, fn.setLengthLeft)(e, 32),
              (0, fn.setLengthLeft)(o, 32)
            ])
          )
        )
      }),
      (e.fromRpcSig = function (t) {
        const e = (0, fn.toBuffer)(t)
        let i, r, n
        if (e.length >= 65)
          (i = e.slice(0, 32)),
            (r = e.slice(32, 64)),
            (n = (0, fn.bufferToInt)(e.slice(64)))
        else {
          if (64 !== e.length) throw new Error('Invalid signature length')
          ;(i = e.slice(0, 32)),
            (r = e.slice(32, 64)),
            (n = (0, fn.bufferToInt)(e.slice(32, 33)) >> 7),
            (r[0] &= 127)
        }
      ...
      (e.hashPersonalMessage = function (t) {
        ...
        return (0, ho.keccak)(Buffer.concat([e, t]))
      })
  }),
  go = bt(function (t, e) {
    var i =
    ...
    e.defineProperties = function (t, e, i) {
      if (
        ...
        (t.toJSON = function (e = !1) {
          ...
          return (0, fn.baToJSON)(t.raw)
        }),
        (t.serialize = function () {
          return Nt.rlp.encode(t.raw)
        }),
        e.forEach((e, i) => {
          function n() {
            return t.raw[i]
          ...
          function s(n) {
            '00' !== (n = (0, fn.toBuffer)(n)).toString('hex') ||
              e.allowZero ||
              (n = Buffer.allocUnsafe(0)),
              e.allowLess && e.length
                ? ((n = (0, fn.unpadBuffer)(n)),
                  (0, r.default)(
                    e.length >= n.length,
        ...
        if (
          ...
          Buffer.isBuffer(i) && (i = Nt.rlp.decode(i)),
          Array.isArray(i))
        ) {
          if (i.length > t._fields.length)
            throw new Error('wrong number of fields in data')
          i.forEach((e, i) => {
            t[t._fields[i]] = (0, fn.toBuffer)(e)
          })
        } else {
  ...
  return (
    void 0 !== t.slice ||
      (t.slice = () => {
        ...
        return vo(new Uint8Array(Array.prototype.slice.apply(t, e)))
      }),
    t
  )
}
var Mo = /*#__PURE__*/ Object.defineProperty(
  {
    keccak256: function (t) {
      return '0x' + bo.keccak_256(wo(t))
    },
    padLeft: (t, e) => {
...
function So(t, e) {
  'object' == typeof e && e.constructor === Uint8Array && (e = Mo.bytesToHex(e))
  const i = Mo.keccak256(e).replace('0x', '')
  for (let e = 0; e < 12; e += 4) {
    const r =
        ...
        2047,
      n = 1 << r % 4
    if ((_o(t.charCodeAt(t.length - 1 - Math.floor(r / 4))) & n) !== n)
      return !1
  }
  return !0
}
...
var Eo = /*#__PURE__*/ Object.defineProperty(
    {
      isBloom: Ao,
      isInBloom: So,
      isUserEthereumAddressInBloom: function (t, e) {
        if (!Ao(t)) throw new Error('Invalid bloom given')
        if (!xo(e)) throw new Error(`Invalid ethereum address given: "${e}"`)
        return So(t, Mo.padLeft(e, 64))
      },
      isContractAddressInBloom: function (t, e) {
        if (!Ao(t)) throw new Error('Invalid bloom given')
        if (!xo(e)) throw new Error(`Invalid contract address given: "${e}"`)
        return So(t, e)
      },
      isTopicInBloom: function (t, e) {
        if (!Ao(t)) throw new Error('Invalid bloom given')
        if (!To(e)) throw new Error('Invalid topic')
        return So(t, e)
      },
      isTopic: To,
      isAddress: xo
  ...
  Oo = function (t) {
    t = t.replace(/^0x/i, '')
    for (var e = qo(t.toLowerCase()).replace(/^0x/i, ''), i = 0; i < 40; i++)
      if (
  ...
  No = function (t) {
    ...
    var e = Io(t),
      i = e.toString(16)
    return e.lt(new It(0)) ? '-0x' + i.substr(1) : '0x' + i
  },
  Lo = function (t, e) {
    if (Bo(t)) return e ? 'address' : '0x' + t.toLowerCase().replace(/^0x/i, '')
    if ('boolean' == typeof t) return e ? 'bool' : t ? '0x01' : '0x00'
    if (Buffer.isBuffer(t)) return '0x' + t.toString('hex')
    if ('object' == typeof t && t && !ko(t) && !Ro(t))
      return e ? 'string' : Po(JSON.stringify(t))
    if ('string' == typeof t) {
      if (0 === t.indexOf('-0x') || 0 === t.indexOf('-0X'))
        return e ? 'int256' : No(t)
      if (0 === t.indexOf('0x') || 0 === t.indexOf('0X')) return e ? 'bytes' : t
      if (!isFinite(t)) return e ? 'string' : Po(t)
    }
    return e ? (t < 0 ? 'int256' : 'uint256') : No(t)
  },
  Do = function (t) {
    return (
  ...
  Uo = '0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470',
  qo = function (t) {
    Ro(t) && (t = t.toString()),
      Do(t) && /^0x/i.test(t.toString())
        ? (t = yo.toBuffer(t))
        : 'string' == typeof t && (t = Buffer.from(t, 'utf-8'))
    var e = yo.bufferToHex(yo.keccak256(t))
    return e === Uo ? null : e
  }
qo._Hash = yo.keccak256
var jo,
  zo,
  Wo,
  $o = {
    ...
    isUserEthereumAddressInBloom: function (t, e) {
      return Eo.isUserEthereumAddressInBloom(t, e)
    },
    isContractAddressInBloom: function (t, e) {
      return Eo.isContractAddressInBloom(t, e)
    },
    isTopic: function (t) {
      return Eo.isTopic(t)
    },
    isTopicInBloom: function (t, e) {
      return Eo.isTopicInBloom(t, e)
    },
    isInBloom: function (t, e) {
      return Eo.isInBloom(t, e)
    },
    checkAddressChecksum: Oo,
    utf8ToHex: Po,
    ...
    hexToNumberString: function (t) {
      ...
      if ('string' == typeof t && !Do(t))
        throw new Error('Given value "' + t + '" is not a valid hex string.')
      return Io(t).toString(10)
    },
    numberToHex: No,
    toHex: Lo,
    hexToBytes: function (t) {
      if (((t = t.toString(16)), !Do(t)))
        throw new Error('Given value "' + t + '" is not a valid hex string.')
      t = t.replace(/^0x/i, '')
    ...
    stripHexPrefix: function (t) {
      return 0 !== t && Fo(t) ? t.replace(/^(-)?0x/i, '$1') : t
    },
    ...
    toTwosComplement: function (t) {
      return '0x' + Io(t).toTwos(256).toString(16, 64)
    },
    sha3: qo,
    sha3Raw: function (t) {
      return null === (t = qo(t)) ? Uo : t
    },
    toNumber: function (t) {
      return 'number' == typeof t ? t : Co(Lo(t))
    }
  },
  Ho = function (t) {
    var e = typeof t
    if ('string' === e)
      return $o.isHexStrict(t)
        ? new It(t.replace(/0x/i, ''), 16)
        : new It(t, 10)
    if ('number' === e) return new It(t)
    if ($o.isBigNumber(t)) return new It(t.toString(10))
  ...
  Go = function (t, e, i) {
    ...
    if (t.startsWith('address')) {
      if (((r = i ? 64 : 40), !$o.isAddress(e)))
        throw new Error(
          e + ' is not a valid address, or the checksum is invalid.'
        )
      return $o.leftPad(e.toLowerCase(), r)
    }
    if (
      ((r = (function (t) {
        var e = /^\D+(\d+).*$/.exec(t)
    ...
    if (t.startsWith('int')) {
      ...
      return n.lt(new It(0))
        ? n.toTwos(r).toString('hex')
        : r
        ? $o.leftPad(n.toString('hex'), (r / 8) * 2)
        : n
    }
  ...
  Zo = function (t) {
    ...
    return Array.isArray(r)
      ? r
          .map(function (t) {
            return Go(e, t, i).toString('hex').replace('0x', '')
          })
          .join('')
      : Go(e, r, i).toString('hex').replace('0x', '')
  },
  Ko = {
    ...
    soliditySha3Raw: function () {
      return $o.sha3Raw(
        '0x' + Array.prototype.slice.call(arguments).map(Zo).join('')
      )
    },
  ...
  Yo = function (t) {
    if (((t = t ? t.toLowerCase() : 'ether'), !kt.unitMap[t]))
      throw new Error(
        'This unit "' +
          t +
          '" doesn\'t exist, please use the one of the following units' +
          JSON.stringify(kt.unitMap, null, 2)
      )
    return t
  },
  Qo = {
    ...
    _jsonInterfaceMethodToString: function (t) {
      return t && 'object' == typeof t && t.name && -1 !== t.name.indexOf('(')
        ? t.name
        : t.name + '(' + Vo(!1, t.inputs).join(',') + ')'
    },
    _flattenTypes: Vo,
    randomHex: function (t) {
      return '0x' + on(t).toString('hex')
    },
    BN: $o.BN,
    isBN: $o.isBN,
    ...
    sha3Raw: $o.sha3Raw,
    keccak256: $o.sha3,
    soliditySha3: Ko.soliditySha3,
    soliditySha3Raw: Ko.soliditySha3Raw,
    encodePacked: Ko.encodePacked,
    ...
    toChecksumAddress: function (t) {
      ...
      for (
        var e = $o.sha3(t).replace(/^0x/i, ''), i = '0x', r = 0;
        r < t.length;
        r++
      )
    ...
    unitMap: kt.unitMap,
    toWei: function (t, e) {
      if (((e = Yo(e)), !$o.isBN(t) && 'string' != typeof t))
        throw new Error(
          'Please pass numbers as strings or BN objects to avoid precision errors.'
        )
      return $o.isBN(t) ? kt.toWei(t, e) : kt.toWei(t, e).toString(10)
    },
    fromWei: function (t, e) {
      ...
      return $o.isBN(t) ? kt.fromWei(t, e) : kt.fromWei(t, e).toString(10)
    },
    padLeft: $o.leftPad,
    leftPad: $o.leftPad,
    padRight: $o.rightPad,
...
class su extends ut {
        ...
        new q(async (u) => {
          ...
          if (!r) {
            ...
            this.logger.log(`DataToken ${r} created`),
              u.next(jo.DataTokenCreated)
          }
          const l = lt.generate(r)
          let d
          this.logger.log('Encrypting files'),
            u.next(jo.EncryptingFiles),
            o
              ? ((d = await gt.getInstance(this.instanceConfig)),
                await d.setBaseUrl(o))
              : (d = this.ocean.provider)
          const f = await d.encrypt(l.getDid(), t.main.files, e)
          this.logger.log('Files encrypted'), u.next(jo.FilesEncrypted)
          let c = 0
          const p = new ct({
            id: l.getDid(),
            dataToken: r,
  ...
  async updateCredentials(t, e, i, r) {
    let n
    return (
      (n = i && i.length > 0 ? ru(t, e, i, 'allow') : eu(t, e, 'allow')),
      (n = r && r.length > 0 ? ru(t, e, r, 'deny') : eu(t, e, 'deny')),
      n
    )
  }
  ...
  async creator(t) {
    const { did: e, ddo: i } = await at(t, this.ocean),
      r = i.getChecksum(),
  ...
  async getServiceByType(t, e) {
    const { ddo: i } = await at(t, this.ocean)
    let r
    return (
      i.service.forEach((t) => {
  ...
  async initialize(t, e, i, r = -1, n, s) {
    const a = await gt.getInstance(this.instanceConfig)
  ...
  async order(t, e, i, r = -1, n, s, a, o = 'json', u = !0) {
    let h
    const { ddo: l } = await at(t, this.ocean),
    ...
    try {
      ...
      const o = new it(await this.ocean.datatokens.balance(t.dataToken, i)),
        d = new it(String(t.numTokens))
      if (o.isLessThan(d))
        throw (
          (this.logger.error(
  ...
  async download(t, e, i, r, n, s = -1, a) {
    const { did: o, ddo: u } = await at(t, this.ocean),
    ...
    const c = await gt.getInstance(this.instanceConfig)
    return (
  ...
  async isConsumable(t, e, i, r) {
    ...
    if (e && null != o && null != (s = o.config) && s.rbacUri) {
      const n = await nu.getInstance(this.instanceConfig)
...
class au extends ut {
  ...
  async get() {
    ...
    try {
      ...
      t.metadataCache = { name: e, status: Wo.Working, version: i }
    } catch (e) {
      t.metadataCache = { name: 'MetadataCache', status: Wo.Stopped }
    }
    const e = Object.values(t)
    return (t.status = { ok: !e.find(({ status: t }) => t !== Wo.Working) }), t
  }
}
class ou {
  constructor(t, e) {
...
class uu extends ut {
  ...
  static async getInstance(t) {
    ...
    return (
      i.setInstanceConfig(t),
      (i.signature = new ou(t.web3, t.logger)),
      (i.fetch = new mt(
        t.logger,
...
const hu = '/api/v1/aquarius/assets/ddo'
class lu {
  get url() {
  ...
  async validateMetadata(t) {
    const e = { valid: !1 },
      i = st(t) ? '/validate-remote' : '/validate'
    try {
      const r = await this.fetch.post(`${this.url}${hu}${i}`, JSON.stringify(t))
      if (r.ok) {
  ...
  async retrieveDDO(t, e) {
    t = t && lt.parse(t)
    const i = e || `${this.url}${hu}/${t.getDid()}`
    return await this.fetch
      .get(i)
      .then((e) =>
        e.ok
...
class du {
  ...
  async publish(t, e, i, r = !1, n = !0) {
    ...
    if (s) return this.publishRaw(D(t), s.flags, s.data, i)
  ...
  async update(t, e, i, r = !1, n = !0) {
    if (n && !(await this.metadataCache.validateMetadata(e)).valid)
      throw new Error('DDO has failed validation')
    const s = await this.prepareRawData(e, r)
    if (s) return this.updateRaw(D(t), s.flags, s.data, i)
    ...
    try {
      return await this.DDOContract.methods
        ...
        .send({
          from: r,
          gas: s + 1,
          gasPrice: await rt(this.web3, this.config)
        })
    } catch (t) {
      return (
...
class fu {
  ...
  async create(t, e, i, r, n) {
    ...
    const u = await s.methods
      .createToken(t, r, n, this.web3.utils.toWei(i))
      .send({ from: e, gas: o + 1, gasPrice: await rt(this.web3, this.config) })
    let h = null
    try {
  ...
  async approve(t, e, i, r) {
    ...
    return await n.methods
      .approve(e, this.web3.utils.toWei(i))
      .send({ from: r, gas: a + 1, gasPrice: await rt(this.web3, this.config) })
  }
  async mint(e, i, r, n) {
    const s = nt(
  ...
  async getBlob(t) {
    const e = nt(new this.web3.eth.Contract(this.datatokensABI, t), this.config)
    ...
    for (let t = 0; t < o.length; t++)
      if (
        ...
        const e = await this.web3.eth.getBlock(o[t].blockHash),
          i = new it(e.timestamp).plus(r)
        if (new it(Math.floor(Date.now() / 1e3)).isLessThan(i))
  ...
  async isMinter(t, e) {
    const i = nt(new this.web3.eth.Contract(this.datatokensABI, t), this.config)
...
class mu extends ut {
  ...
  async start(t, e, i, r, n, s, a, o, u, h) {
    ...
    if (l && e) {
      const t = await gt.getInstance(this.instanceConfig)
  ...
  async stop(t, e, i) {
    const { did: r, ddo: n } = await at(e, this.ocean),
      s = n.findServiceByType('compute'),
      { serviceEndpoint: a } = s,
      o = await gt.getInstance(this.instanceConfig)
  ...
  async status(t, e, i, r, n, s) {
    ...
    if (e || r || i) {
      ...
      ;(a = await gt.getInstance(this.instanceConfig)), await a.setBaseUrl(t)
  ...
  async getResult(t, e, i, r, n, s, a) {
    ...
    if (n || a || s) {
      ...
      ;(o = await gt.getInstance(this.instanceConfig)), await o.setBaseUrl(t)
    ...
    if ('compute' === s.type) {
      ...
      if (i.did) {
        if (i.serviceIndex) {
          ...
          if (t && 'compute' === t.type) {
            const e = await gt.getInstance(this.instanceConfig)
            await e.setBaseUrl(t.serviceEndpoint)
            const i = await gt.getInstance(this.instanceConfig)
            if (
  ...
  orderAsset(t, e, i, r, n, s, a, o = 'json', u = !0) {
    return new q(async (h) => {
      const { ddo: l } = await at(e, this.ocean)
...
class Mu extends class extends class {
  ...
  async setup(t, e, i, r, n, s, a, o, u) {
    ...
    try {
      l = await h.methods
        .setup(i, r, n, s, a, o, u)
        .send({ from: t, gas: f, gasPrice: await rt(this.web3, this.config) })
    } catch (t) {
  ...
  async sharesBalance(t, e) {
    let i = null
    try {
      const r = nt(new this.web3.eth.Contract(this.poolABI, e), this.config),
  ...
  async getNumTokens(t) {
    const e = nt(new this.web3.eth.Contract(this.poolABI, t), this.config)
    let i = null
    try {
  ...
  async isBound(t, e) {
    const i = nt(new this.web3.eth.Contract(this.poolABI, t), this.config)
    let r = null
    try {
  ...
  async getReserve(t, e) {
    let i = null
    try {
      const r = nt(new this.web3.eth.Contract(this.poolABI, t), this.config),
  ...
  async exitPool(t, e, i, r) {
    ...
    try {
      o = await n.methods
        .exitPool(this.web3.utils.toWei(i), s)
        .send({ from: t, gas: h, gasPrice: await rt(this.web3, this.config) })
    } catch (t) {
  ...
  async calcSpotPrice(t, e, i, r, n, s) {
    const a = nt(new this.web3.eth.Contract(this.poolABI, t), this.config)
    let o = '0'
    try {
  ...
  async calcInGivenOut(e, i, r, n, s, a, o) {
    const u = nt(new this.web3.eth.Contract(this.poolABI, e), this.config)
    let h = null
  ...
  async calcOutGivenIn(t, e, i, r, n, s, a) {
    const o = nt(new this.web3.eth.Contract(this.poolABI, t), this.config)
    let u = null
    try {
  ...
  async getResult(t, e) {
    ...
    if (parseFloat(i) > 0) {
      ...
      if (t) return { shares: i, poolAddress: e.returnValues[0], did: L(F(t)) }
    }
  }
  ...
  async computeSlippage(e, i, r, n, s, a, o, u) {
    const h = await super.calcSpotPrice(e, i, r, n, s, u),
      l = await super.calcSpotPrice(e, a, r, o, s, u)
    return new t(l).mul(100).div(h).minus(100).toString()
  }
  async computeBuySlippage(t, e) {
    const i = await this.getDTAddress(t),
      ...
      h = new it(this.web3.utils.toWei(s)).minus(this.web3.utils.toWei(u)),
      l = new it(this.web3.utils.toWei(a)).plus(this.web3.utils.toWei(e))
  ...
  async computeSellSlippage(t, e) {
    const i = await this.getDTAddress(t),
      ...
      h = new it(this.web3.utils.toWei(s)).plus(this.web3.utils.toWei(e)),
      l = new it(this.web3.utils.toWei(a)).minus(this.web3.utils.toWei(u))
    return await this.computeSlippage(
      t,
      s,
      r,
...
class Au {
  constructor(t, e, i = null, r = null, n = null, s, a) {
    ;(this.GASLIMIT_DEFAULT = 1e6),
      ...
      (this.config = a),
      (this.startBlock = (a && a.startBlock) || 0),
      (this.fixedRateExchangeABI = r || _.abi),
      (this.oceanAddress = n),
      (this.datatokens = s),
      t &&
        (this.contract = nt(
  ...
  async setRate(t, e, i) {
    ...
    return await this.contract.methods
      .setRate(t, this.web3.utils.toWei(String(e)))
      .send({ from: i, gas: n + 1, gasPrice: await rt(this.web3, this.config) })
  }
  async activate(t, e) {
    ...
    return await this.contract.methods
      .toggleExchangeState(t)
      .send({ from: e, gas: n + 1, gasPrice: await rt(this.web3, this.config) })
  }
...
class _u extends ut {
  ...
  static async getInstance(t) {
    ...
    return (
      ...
      (i.utils = await uu.getInstance(r)),
      (i.provider = await gt.getInstance(r)),
      (i.eventAccessControl = await nu.getInstance(r)),
      (i.metadataCache = new lu(
        r.config.metadataCacheUri,
        r.logger,
        null == (e = r.config) ? void 0 : e.requestTimeout
      )),
      (i.accounts = await dt.getInstance(r)),
      (i.assets = await su.getInstance(r)),
      (i.compute = await mu.getInstance(r)),
      (i.datatokens = new fu(
      ...
      (i.versions = await au.getInstance(r)),
      (i.network = new cu()),
      i
    )
  }
...
async function Iu(t, e, i, r, n, s) {
  const a = await Ru(t, n)
  return await ku(e, a, i, r, s)
}
var Bu,
  Ou = [
    {
...
async function Cu(t) {
  return new it(await t.eth.getGasPrice())
    .multipliedBy(1.05)
    .integerValue(it.ROUND_DOWN)
    .toString(10)
}
...
const Nu = new (class {
    ...
    debug(...t) {
      this.dispatch('debug', Bu.Verbose, ...t)
    }
    log(...t) {
      this.dispatch('log', Bu.Log, ...t)
    }
    warn(...t) {
      this.dispatch('warn', Bu.Warn, ...t)
    }
    error(...t) {
      this.dispatch('error', Bu.Error, ...t)
    }
    dispatch(t, e, ...i) {
      this.logLevel >= e && console[t](...i)
    }
  ...
  Lu = (t) =>
    (function (t = '', e) {
      const { valid: i, output: r } = (function (t, e, i) {
        ...
        return r
          ? { valid: !0, output: r[1] }
          : (Nu.warn('[zeroXTransformer] Input transformation failed.'),
            { valid: !1, output: t })
      })(t)
      return (e && i ? '0x' : '') + r
    })(t, !1),
  Du = new (class {
    async getEndpoints(t) {
      try {
        ...
        return Nu.error('Finding the service endpoints failed:', t), null
      }
    }
    getEndpointURL(t, e) {
    ...
    async getNonce(t, e, i, r, n) {
      ...
      try {
        ...
        throw (Nu.error(t), new Error('HTTP request failed'))
      }
    }
    async createSignature(t, e, i) {
      const r = await (async function (t, e, i, r) {
        ...
        try {
          ...
          if (n) throw r
          Nu.warn('Error on personal sign.'), Nu.warn(r)
          try {
            return await t.eth.sign(e, i)
          } catch (t) {
            throw (
              (Nu.error('Error on sign.'),
              Nu.error(t),
              new Error('Error executing personal sign'))
            )
          }
    ...
    async createHashSignature(t, e, i) {
      const r = await (async function (t, e, i, r) {
        ...
        try {
          ...
          if (s) throw e
          Nu.warn('Error on personal sign.'), Nu.warn(e)
          try {
    ...
    async getComputeEnvironments(t, e) {
      ...
      try {
        ...
        return Nu.error(t.message), null
      }
    }
    async initialize(t, e, i, r, n, a, o, u, h) {
      const l = await this.getEndpoints(n),
        d = await this.getServiceEndpoints(n, l)
      let f = this.getEndpointURL(d, 'initialize')
      ...
      try {
        ...
        throw (Nu.error(t), new Error('Asset URL not found or not available.'))
      }
    }
    ...
    async computeStart(t, e, i, r, n, a, o, u, h) {
      const l = await this.getEndpoints(t),
        d = await this.getServiceEndpoints(t, l),
        f = this.getEndpointURL(d, 'computeStart')
      ...
      try {
        ...
        return null != t && t.ok
          ? await t.json()
          : (console.error('Compute start failed:', t.status, t.statusText),
            Nu.error('Payload was:', g),
            null)
      } catch (t) {
        return (
          Nu.error('Compute start failed:'),
          Nu.error(t),
          Nu.error('Payload was:', g),
          null
        )
    ...
    async computeStop(t, e, i, r, n, a) {
      const o = await this.getEndpoints(r),
        ...
        h = this.getEndpointURL(u, 'computeStop')
          ...
          : null,
        l = await this.getNonce(r, e, a, o, u)
      let d = e
      ;(d += i || ''), (d += (t && `${Lu(t)}`) || ''), (d += l)
      const f = await this.createHashSignature(n, e, d),
        c = Object()
      if (
        ((c.signature = f),
        (c.documentId = Lu(t)),
      ...
      try {
        ...
        return null != t && t.ok
          ? await t.json()
          : (Nu.error('Compute stop failed:', t.status, t.statusText),
            Nu.error('Payload was:', c),
            null)
      } catch (t) {
        return (
          Nu.error('Compute stop failed:'),
          Nu.error(t),
          Nu.error('Payload was:', c),
          null
        )
    ...
    async computeStatus(t, e, i, r, n) {
      ...
      try {
        ...
        return null != t && t.ok
          ? await t.json()
          : (Nu.error('Get compute status failed:', t.status, t.statusText),
            null)
      } catch (t) {
        return Nu.error('Get compute status failed'), Nu.error(t), null
      }
    }
    async computeResult(t, e, i, r, n, a) {
      const o = await this.getEndpoints(r),
        ...
        h = this.getEndpointURL(u, 'computeResult')
          ...
          : null,
        l = await this.getNonce(r, i, a, o, u)
      let d = i
      ;(d += t), (d += String(e)), (d += l)
      const f = await this.createHashSignature(n, i, d)
      let c = h
      if (
        ((c += `?consumerAddress=${i}`),
        (c += `&jobId=${t}`),
      ...
      try {
        ...
        throw (Nu.error('Error getting job result'), Nu.error(t), t)
      }
    }
    async computeDelete(t, e, i, r, n, a) {
      ...
      try {
        ...
        return null != t && t.ok
          ? await t.json()
          : (Nu.error('Delete compute job failed:', t.status, t.statusText),
            Nu.error('Payload was:', c),
            null)
      } catch (t) {
        return (
          Nu.error('Delete compute job failed:'),
          Nu.error(t),
          Nu.error('Payload was:', c),
          null
        )
    ...
    async isValidProvider(t, e) {
      try {
        ...
        return Nu.error(`Error validating provider: ${t.message}`), !1
      }
    }
  })()
class Fu {
  ...
  async getAssetURL(t, e, i, r) {
    ...
    try {
      const s = new Eu().getConfig(i, r)
      s.web3Provider = this.web3
      const a = await _u.getInstance(s)
  ...
  async estGasPublishFixedRateAsset(
    ...
    const g = new this.web3.eth.Contract(Ou, i),
  ...
  async publishFixedRateAsset(t, e, i, r, n, s, a, o, u, h, l, d, f, c, p, m) {
    ...
    try {
      b = await g.methods
        ...
        .send({ from: s, gas: y + 1, gasPrice: await Cu(this.web3) })
    } catch (t) {
      console.log('error', t)
    }
    return b
  ...
  async estGaspublishFreeAsset(t, e, i, r, n, s, a, o, u, h, l, d) {
    const f = new this.web3.eth.Contract(Ou, e),
      c = Buffer.from(
  ...
  async publishFreeAsset(t, e, i, r, n, s, a, o, u, h, l, d) {
    ...
    try {
      p = await f.methods
        ...
        .send({ from: n, gas: c + 1, gasPrice: await Cu(this.web3) })
    } catch (t) {
      console.log('error', t)
    }
    return p
  ...
  async updateMetadata(t, e, i, r, n, s, a, o, u) {
    ...
    try {
      d = await h.methods
        .setMetaData(i, r, n, s, a, o, u)
        .send({ from: t, gas: l + 1, gasPrice: await Cu(this.web3) })
    } catch (t) {
  ...
  async migrateFixedRateAsset(
    ...
    let _
    const T = (await Ru(t, y)).service[0].attributes.additionalInformation
      .description
    try {
    ...
    const x = _.events.NFTCreated.returnValues.newTokenAddress,
      ...
      B = await Iu(t, I, x, E, y, k),
      O = await Du,
      P = await O.encrypt(B, S || g),
    ...
    let D
    try {
      D = await this.updateMetadata(n, _, p, S || g, m, u, P, C, [N])
    } catch (t) {
      console.log('Error', t)
    }
    return { txReceipt: _, txReceipt2: D }
  }
  async migrateFreeAsset(
    ...
    let v
    const M = (await Ru(t, c)).service[0].attributes.additionalInformation
      .description
    try {
    ...
    let P
    try {
      P = await this.updateMetadata(n, v, l, f, d, o, k, I, [B])
    } catch (t) {
      console.log('Error', t)
    }
