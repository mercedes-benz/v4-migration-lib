...
export class Pool extends PoolFactory {
   ...
   */
  async allowance(tokenAdress, owner, spender) {
   ...
   */
  async approve(account, tokenAddress, spender, amount, force = false) {
    const minABI = [
      {
        constant: false,
        inputs: [
   ...
   * @return {String}
   */
  async sharesBalance(account, poolAddress) {
    let result = null
    try {
      const token = setContractDefaults(
        new this.web3.eth.Contract(this.poolABI, poolAddress),
   ...
   */
  async addToPool(account, poolAddress, tokens) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress, {
        from: account
      }),
   ...
   */
  async setSwapFee(account, poolAddress, fee) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress, {
        from: account
      }),
   ...
   * @param {String} poolAddress
   */
  async finalize(account, poolAddress) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress, {
        from: account
      }),
   ...
   * @return {String}
   */
  async getNumTokens(poolAddress) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {String}
   */
  async getPoolSharesTotalSupply(poolAddress) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {String[]}
   */
  async getCurrentTokens(poolAddress) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {String[]}
   */
  async getFinalTokens(poolAddress) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {String}
   */
  async getController(poolAddress) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {String}
   */
  async setController(account, poolAddress, controllerAddress) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress, {
        from: account
      }),
   ...
   * @return {Boolean}
   */
  async isBound(poolAddress, token) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {String}
   */
  async getReserve(poolAddress, token) {
    let amount = null
    try {
      const pool = setContractDefaults(
        new this.web3.eth.Contract(this.poolABI, poolAddress),
   ...
   * @return {String}
   */
  async getNormalizedWeight(poolAddress, token) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {String}
   */
  async getDenormalizedWeight(poolAddress, token) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {String}
   */
  async getTotalDenormalizedWeight(poolAddress) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {TransactionReceipt}
   */
  async joinPool(account, poolAddress, poolAmountOut, maxAmountsIn) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress, {
        from: account
      }),
   ...
   * @return {TransactionReceipt}
   */
  async exitPool(account, poolAddress, poolAmountIn, minAmountsOut) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress, {
        from: account
      }),
   ...
   * @return {String}
   */
  async getSpotPrice(poolAddress, tokenIn, tokenOut) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
   ...
   * @return {String}
   */
  async getSpotPriceSansFee(poolAddress, tokenIn, tokenOut) {
    const pool = setContractDefaults(
      new this.web3.eth.Contract(this.poolABI, poolAddress),
      this.config
    )
  ...
  async calcPoolOutGivenSingleIn(
    poolAddress,
    tokenBalanceIn,
    tokenWeightIn,
    poolSupply,
  ...
  async calcSingleInGivenPoolOut(
    poolAddress,
    tokenBalanceIn,
    tokenWeightIn,
    poolSupply,
  ...
  async calcPoolInGivenSingleOut(
    poolAddress,
    tokenBalanceOut,
    tokenWeightOut,
    poolSupply,
