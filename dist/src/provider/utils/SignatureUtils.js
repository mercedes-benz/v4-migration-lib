...
export async function signText(web3, text, publicKey, password) {
  const isMetaMask =
...
export async function signHash(web3, message, address) {
...
export async function signWithHash(web3, text, publicKey, password) {
